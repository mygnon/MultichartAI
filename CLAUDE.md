...
| **PivotBreakout** (PivMult, ATRMult, ReentryBars) | $15,107 (0.25/13/22 Obj=40,005) | daily-pivot breakout (PP±PivMult*priorday-range, HighD/LowD/CloseD) = 6th reference; **WEAKEST of the 6**. see matrix below. Exit modules 6/6 HURT → MAIN only. OOS no strict PASS (NQ break 1.005× near-miss) |
