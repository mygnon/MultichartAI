"""
run_btc_ccb_daily_pipeline.py -- ONE-BAT unattended 4-stage pipeline for
SFJ_CloseChannelBreakout_crypto on BTCUSDT HOT DAILY.
...
PREREQUISITES (MC64 as Administrator):
  20260622_SFJ_CloseChannelBreakout_crypto_AI.wsp open; BTCUSDT HOT DAILY tab active+visible;
...
CLI:
  py run_btc_ccb_daily_pipeline.py                 # full pipeline (auto-elevates)
  py run_btc_ccb_daily_pipeline.py --from-stage 3  # resume from stage 3 (uses state.json)
  py run_btc_ccb_daily_pipeline.py --from-csv      # re-analyse existing CSVs, no MC64
"""
...
OUTPUT_DIR  = Path(r"C:\Users\Tim\MultichartAI\results\btc_ccb_daily_pipeline")
