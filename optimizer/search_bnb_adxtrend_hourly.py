"""
search_bnb_adxtrend_hourly.py -- SFJ_ADXtrend_crypto on BNBUSDT HOT Hourly, Round 1 (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_adxtrend_hourly_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT = 14.0, 25.0, 3.0  # DMILen, ADXThresh, ATRMult

PREFIX = "BNBADX_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_adxtrend_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_adxtrend_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_ADXtrend_crypto on BNBUSDT HOT Hourly -- Round 1 (IS 2022/01-2026/01)")
    ...
    # static attempts (3D)
    _do(1, "01_global_wide",  _cfg("01_global_wide",  (5,40,2),   (15,45,3),    (1.5,6.0,0.5)))   # DMILen x ADXThresh x Trail
    _do(2, "02_default_zone", _cfg("02_default_zone", (8,24,2),   (18,35,2),    (2.0,4.0,0.5)))
    _do(3, "03_dmilen_fine",  _cfg("03_dmilen_fine",  (2,40,2),   (20,30,2),    (2.5,4.5,0.5)))
    _do(4, "04_thresh_scan",  _cfg("04_thresh_scan",  (10,20,2),  (10,50,2),    (2.5,4.0,0.5)))
    _do(5, "05_mult_fine",    _cfg("05_mult_fine",    (10,20,2),  (20,30,2),    (1.0,8.0,0.25)))
    _do(6, "06_short_dmilen", _cfg("06_short_dmilen", (2,16,1),   (15,35,2),    (2.0,5.0,0.5)))
    _do(7, "07_long_dmilen",  _cfg("07_long_dmilen",  (20,80,4),  (15,35,2),    (2.0,5.0,0.5)))
    _do(8, "08_low_thresh",   _cfg("08_low_thresh",   (6,30,2),   (8,22,2),     (2.0,6.0,0.5)))
    _do(9, "09_global_bound", _cfg("09_global_bound", (2,80,6),   (10,55,5),    (1.0,9.0,1.0)))
    ...
    log.info("==============================================================")
    log.info("  SFJ_ADXtrend_crypto BNBUSDT Hourly Round-1 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
