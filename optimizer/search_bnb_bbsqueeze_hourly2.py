"""
search_bnb_bbsqueeze_hourly.py -- SFJ_BBSqueeze_crypto on BNBUSDT HOT Hourly, R2 integer-grid + boundary confirm
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_bbsqueeze_hourly2_search")
...
SEED_TR, SEED_RL, SEED_TH, SEED_MULT = 14.0, 1.75, 40.0, 8.3  # BBLen, BBmult, SqueezeLen, ATRMult (R1 champ)

PREFIX = "BNBBBS2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_bbsqueeze_hourly2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_bbsqueeze_hourly2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_BBSqueeze_crypto on BNBUSDT HOT Hourly -- Round 2 integer-grid + boundary confirm (IS 2022/01-2026/01)")
    ...
    # static attempts (4D)
    # static attempts (INTEGER BBLen/SqueezeLen; BBmult/ATRMult fractional) around BBLen14/BBm1.75/Sqz40/M8.3
    _do(1, "01_rule5_retest",_cfg("01_rule5_retest",(10,18,1), (1.5,2.25,0.25),(30,50,5),  (7,9.5,0.5)))   # 1080
    _do(2, "02_bblen_fine",  _cfg("02_bblen_fine",  (5,30,1),  (1.5,2.0,0.25), (35,45,5),  (7.5,9,0.5)))
    _do(3, "03_bbmult_scan", _cfg("03_bbmult_scan", (12,16,2), (0.75,3.5,0.25),(35,45,5),  (7.5,9,0.5)))   # BBmult sweep
    _do(4, "04_sqzlen_scan", _cfg("04_sqzlen_scan", (12,16,2), (1.5,2.0,0.25), (10,100,5), (7.5,9,0.5)))   # SqueezeLen sweep
    _do(5, "05_mult_push",   _cfg("05_mult_push",   (12,16,2), (1.5,2.0,0.25), (35,45,5),  (5,16,0.5)))    # ATRMult 5-16
    _do(6, "06_ultra_wide_m",_cfg("06_ultra_wide_m",(12,16,2), (1.5,2.0,0.25), (35,45,5),  (9,20,0.5)))    # M beyond 8.3
    _do(7, "07_short_bblen", _cfg("07_short_bblen", (3,14,1),  (1.5,2.25,0.25),(30,50,10), (7,9,0.5)))
    _do(8, "08_sqz_dense",   _cfg("08_sqz_dense",   (12,16,1), (1.5,2.0,0.25), (35,45,2),  (7.5,9,0.5)))   # SqueezeLen dense
    _do(9, "09_global_int",  _cfg("09_global_int",  (5,60,5),  (1,3.5,0.5),    (20,120,20),(4,10,2)))
    ...
    log.info("==============================================================")
    log.info("  SFJ_BBSqueeze_crypto BNBUSDT Hourly Round-2 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
