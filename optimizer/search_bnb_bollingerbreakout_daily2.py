"""
search_bnb_bollingerbreakout_daily.py -- SFJ_BollingerBreakout_crypto on BNBUSDT HOT Daily, Round 2 confirm (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_bollingerbreakout_daily_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT, SEED_RE = 3.0, 1.0, 5.0, 12.0  # BBLen, BBmult, ATRMult, ReentryBars (R1 A07 best)

PREFIX = "BNBBOD_R2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_bollingerbreakout_daily2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_bollingerbreakout_daily2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto on BNBUSDT HOT Daily -- Round 2 confirm (IS 2022/01-2026/01; seed R1 3/1.0/5.0/12, sparse 13tr)")
    ...
    # R2 confirm around R1 A07 best: BBLen=3 BBmult=1.0 ATRMult=5.0 ReentryBars=12 (DAILY, sparse 13tr)
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (2,4,1),    (0.8,1.2,0.1), (4.5,5.5,0.25),(11,13,1)))  # Rule 5 baseline
    _do(2, "02_bblen_fine",   _cfg("02_bblen_fine",   (2,12,1),   (0.8,1.2,0.1), (4.5,5.5,0.25),(10,14,2)))  # nail BBLen 2-12
    _do(3, "03_bbmult_fine",  _cfg("03_bbmult_fine",  (2,4,1),    (0.5,2.0,0.05),(4.5,5.5,0.25),(11,13,1)))  # nail BBmult 0.5-2
    _do(4, "04_atrmult_fine", _cfg("04_atrmult_fine", (2,4,1),    (0.8,1.2,0.1), (3.5,7.0,0.25),(11,13,1)))  # nail ATRMult 3.5-7
    _do(5, "05_atrmult_wide", _cfg("05_atrmult_wide", (2,5,1),    (0.8,1.2,0.1), (5.0,12.0,0.5),(10,14,2)))  # wider trail check
    _do(6, "06_reentry_fine", _cfg("06_reentry_fine", (2,4,1),    (0.8,1.2,0.1), (4.5,5.5,0.25),(0,24,1)))   # nail ReentryBars 0-24
    _do(7, "07_bblen_vshort", _cfg("07_bblen_vshort", (2,8,1),    (0.5,1.5,0.1), (4.0,6.0,0.25),(8,14,1)))   # very short BBLen
    _do(8, "08_combo_tight",  _cfg("08_combo_tight",  (2,5,1),    (0.7,1.3,0.05),(4.5,5.5,0.25),(11,13,1)))  # tight combo at peak
    _do(9, "09_bbmult_high",  _cfg("09_bbmult_high",  (2,4,1),    (1.2,3.0,0.1), (4.5,5.5,0.25),(11,13,1)))  # check BBmult above 1.0
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto BNBUSDT Daily Round-2 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_BollingerBreakout_crypto BNBUSDT HOT Daily R2 confirm")
