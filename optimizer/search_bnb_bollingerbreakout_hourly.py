"""
search_bnb_bollingerbreakout_hourly.py -- SFJ_BollingerBreakout_crypto on BNBUSDT HOT Hourly, Round 1 (IS 2022/01-2026/01)
...
_LOG_FILE = OUTPUT_DIR / f"search_bnb_bollingerbreakout_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_bollingerbreakout_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto on BNBUSDT HOT Hourly -- Round 1 (IS 2022/01-2026/01)")
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto BNBUSDT Hourly Round-1 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_BollingerBreakout_crypto BNBUSDT HOT Hourly R1 search")
