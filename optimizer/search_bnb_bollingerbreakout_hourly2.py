"""
search_bnb_bollingerbreakout_hourly.py -- SFJ_BollingerBreakout_crypto on BNBUSDT HOT Hourly, Round 2 confirm (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_bollingerbreakout_hourly_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT, SEED_RE = 13.0, 1.65, 7.0, 12.0  # BBLen, BBmult, ATRMult, ReentryBars (R1 A11 best)

PREFIX = "BNBBO_R2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_bollingerbreakout_hourly2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_bollingerbreakout_hourly2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto on BNBUSDT HOT Hourly -- Round 2 confirm (IS 2022/01-2026/01; seed R1 13/1.65/7/12)")
    ...
    # R2 confirmation around R1 A11 best: BBLen=13 BBmult=1.65 ATRMult=7 ReentryBars=12
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (12,14,1),  (1.5,1.8,0.15),(6.5,7.5,0.5),(11,13,1)))  # Rule 5 in-session baseline
    _do(2, "02_bblen_fine",   _cfg("02_bblen_fine",   (8,18,1),   (1.5,1.8,0.1), (6.5,7.5,0.25),(10,14,2)))  # nail BBLen 8-18
    _do(3, "03_bbmult_fine",  _cfg("03_bbmult_fine",  (11,15,1),  (1.3,2.2,0.05),(6.5,7.5,0.5), (11,13,1)))  # nail BBmult 1.3-2.2
    _do(4, "04_atrmult_fine", _cfg("04_atrmult_fine", (11,15,1),  (1.5,1.8,0.15),(5.5,9,0.25),  (11,13,1)))  # nail ATRMult 5.5-9
    _do(5, "05_reentry_fine", _cfg("05_reentry_fine", (11,15,2),  (1.5,1.8,0.15),(6.5,7.5,0.5), (4,30,2)))   # nail ReentryBars 4-30
    _do(6, "06_bblen_low",    _cfg("06_bblen_low",    (3,16,1),   (1.5,2,0.25),  (6.5,7.5,0.5), (10,14,2)))  # check BBLen below 13
    _do(7, "07_combo_tight",  _cfg("07_combo_tight",  (11,16,1),  (1.5,1.9,0.1), (6.5,7.5,0.25),(11,14,1)))  # tight combo at peak
    _do(8, "08_wide_trail",   _cfg("08_wide_trail",   (11,15,2),  (1.5,1.8,0.15),(8,16,1),      (10,14,2)))  # confirm ATRMult>8 worse
    _do(9, "09_bbmult_low",   _cfg("09_bbmult_low",   (10,16,1),  (1.0,1.6,0.1), (6.5,7.5,0.5), (11,13,1)))  # check BBmult below 1.65
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto BNBUSDT Hourly Round-2 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_BollingerBreakout_crypto BNBUSDT HOT Hourly R2 confirm")
