"""
search_bnb_closechannelbreakout_hourly2.py -- SFJ_CloseChannelBreakout_crypto on BNBUSDT HOT Hourly, Round 2 (confirm R1 Length=8 ATRMult=7 ReentryBars=14)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_closechannelbreakout_hourly2_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT = 8.0, 7.0, 14.0  # R2 seed = R1 champion (5-conv)

PREFIX = "BNBCCB2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_closechannelbreakout_hourly2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_closechannelbreakout_hourly2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_VolatilityBreakout_crypto on BNBUSDT HOT Hourly -- Round 2 (confirm R1 Length=8 ATRMult=7 ReentryBars=14)")
    ...
    # static attempts (3D)
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (6,10,1),    (6.0,8.0,0.5),  (12,16,1)))   # Rule-5 + tight box (incl 8/7/14)
    _do(2, "02_length_fine",  _cfg("02_length_fine",  (2,20,1),    (6.5,7.5,0.5),  (13,15,1)))
    _do(3, "03_atrmult_fine", _cfg("03_atrmult_fine", (6,10,1),    (4.0,11.0,0.25),(13,15,1)))
    _do(4, "04_reentry_fine", _cfg("04_reentry_fine", (6,10,1),    (6.5,7.5,0.5),  (0,30,1)))
    _do(5, "05_length_x_atr", _cfg("05_length_x_atr", (4,14,1),    (5.0,9.0,0.5),  (13,15,1)))
    _do(6, "06_wide_trail",   _cfg("06_wide_trail",   (5,12,1),    (7.0,20.0,0.5), (10,18,2)))
    _do(7, "07_short_len",    _cfg("07_short_len",    (2,12,1),    (5.0,9.0,0.5),  (10,18,2)))
    _do(8, "08_combo_2d",     _cfg("08_combo_2d",     (4,14,1),    (6.0,8.0,0.25), (10,18,1)))
    _do(9, "09_atrmult_low",  _cfg("09_atrmult_low",  (6,10,1),    (0.5,7.0,0.5),  (12,16,1)))
    ...
    log.info("==============================================================")
    log.info("  SFJ_CloseChannelBreakout_crypto BNBUSDT Hourly Round-2 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_VolatilityBreakout_crypto BNBUSDT HOT Hourly R1 search")
