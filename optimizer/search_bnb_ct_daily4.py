"""
search_bnb_ct_daily4.py — SFJ_15Dworkshop_lesson5_countertrend_LS_crypto on BNBUSDT HOT Daily, Round 4
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_ct_daily4_search")
...
SEED_LL, SEED_SL = 15.0, 2.175
SEED_LS, SEED_SS = 21.0, 3.15
SEED_NP          = 0.0

PREFIX = "BNBCTD4_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_ct_daily4_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    payload = {
        ...
        "notes": {
            ...
            "r3_champion": "LL=15 SL=2.175 LS=21 SS=3.15 NP=42542 MDD=-6645 Obj=272358 14tr (broke R1=R2 false ceiling +20.9%)",
            "r4_goal":  "Confirm R3 champion (R1=R2 was FALSE ceiling — R2 fixed SL too narrow). SL wide 1.0-3.5, LL bridge 8-30, LS/SS sweeps. Target 100K likely unreachable.",
        },
        "best_params":  best_entry,
        "all_attempts": attempt_log,
    }
    out = OUTPUT_DIR / "final_params_bnb_ct_daily4.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  BNB Daily countertrend_LS_crypto NP>100K -- Round 4")
    log.info("  IS window %s ~ %s  (chart-trimmed)", IS_RANGE[0], IS_RANGE[1])
    log.info("  R3 champ LL=15 SL=2.175 LS=21 SS=3.15 NP=42542 (R1=R2 was FALSE ceiling; confirm R3)")
    log.info("==============================================================")

    if not from_csv and conn is not None:
        mc.ensure_chart_ready(conn, _cfg("seed", (13, 17, 1), (2.0, 2.4, 0.1),
                                         (19, 23, 1), (3.0, 3.3, 0.1)))
    ...
    attempts_config = [
        ("01_SL_wide",          (13, 17, 1),   (1.0, 3.5, 0.1),   (19, 23, 1),    (3.0, 3.3, 0.1)),
        ("02_LL_bridge",        (8, 30, 1),    (2.0, 2.4, 0.1),   (19, 23, 1),    (3.0, 3.3, 0.1)),
        ("03_LS_sweep",         (13, 17, 1),   (2.0, 2.4, 0.1),   (10, 40, 2),    (3.0, 3.3, 0.1)),
        ("04_SS_sweep",         (13, 17, 1),   (2.0, 2.4, 0.1),   (19, 23, 1),    (2.0, 4.5, 0.15)),
        ("05_short_LL_deep",    (2, 14, 1),    (1.5, 3.0, 0.2),   (12, 30, 3),    (2.5, 3.5, 0.25)),
        ("06_mid_LL_SLwide",    (18, 30, 2),   (1.5, 3.0, 0.2),   (18, 26, 2),    (2.8, 3.4, 0.2)),
        ("07_obj_hifreq_check", (2, 8, 1),     (1.0, 2.0, 0.2),   (5, 15, 1),     (0.8, 1.6, 0.2)),
        ("08_global_reverify",  (10, 40, 3),   (1.5, 2.6, 0.15),  (15, 35, 3),    (2.5, 3.6, 0.2)),
    ]
    ...
    log.info("==============================================================")
    log.info("  BNB Daily countertrend_LS_crypto Round-4 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="BNB Daily countertrend_LS_crypto NP>100K Round-4 search")
