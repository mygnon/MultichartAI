...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_donchian_v2_daily_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT, SEED_TR, SEED_RE = 20.0, 14.0, 3.0, 100.0, 5.0

PREFIX = "BNBDONV2D_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_donchian_v2_daily_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_donchian_v2_daily.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_DonchianATR_crypto_v2 on BNBUSDT HOT Daily -- Round 1 (IS 2022/01-2026/01)")
    log.info("  Params: Length, ATRLength, ATRMult, TrendLen, ReentryBars.  Obj=NP^2/|MDD|.  Target %.0f", TARGET_NP)
    log.info("  Default: 20/14/3.0/100/5.  Run start: %s", datetime.now().isoformat())
    log.info("==============================================================")
    ...
    if not from_csv and conn is not None:
        ...
        for _try in range(3):
            try:
                mc.ensure_chart_ready(conn, _cfg("seed", (18, 22, 2), (12, 16, 2),
                                                 (2.5, 3.5, 0.5), (80, 120, 20), (3, 7, 2)))
    ...
    # static attempts (5D)
    _do(1, "01_global_wide",  _cfg("01_global_wide",  (10,60,10),(10,20,10),(2,4,1),    (50,200,50), (0,10,5)))
    _do(2, "02_default_zone", _cfg("02_default_zone", (10,30,5), (10,20,5), (2,4,0.5),  (60,140,20), (0,8,4)))
    _do(3, "03_len_mult",     _cfg("03_len_mult",     (5,50,5),  (10,18,4), (1.5,5,0.5),(80,120,40), (2,8,3)))
    _do(4, "04_trend_filter", _cfg("04_trend_filter", (15,25,5), (10,18,4), (2.5,4,0.5),(30,300,30), (0,8,4)))
    _do(5, "05_reentry_scan", _cfg("05_reentry_scan", (15,25,5), (10,18,4), (2.5,4,0.5),(80,160,40), (0,30,3)))
    _do(6, "06_mult_fine",    _cfg("06_mult_fine",    (15,30,5), (10,18,4), (1,8,0.5),  (80,120,40), (3,9,3)))
    _do(7, "07_short_len",    _cfg("07_short_len",    (5,25,2),  (8,16,4),  (2,4,0.5),  (50,150,50), (2,8,3)))
    _do(8, "08_long_len",     _cfg("08_long_len",     (40,120,10),(10,20,5),(2,5,0.5),  (100,300,100),(0,10,5)))
    _do(9, "09_global_bound", _cfg("09_global_bound", (5,150,15),(6,30,8),  (1,6,1),    (40,280,60), (0,20,10)))
    ...
    log.info("==============================================================")
    log.info("  SFJ_DonchianATR_crypto_v2 BNBUSDT Daily Round-1 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
