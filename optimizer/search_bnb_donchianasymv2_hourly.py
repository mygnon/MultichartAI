"""
search_bnb_donchianasym_hourly.py -- SFJ_DonchianAsymV2_crypto on BNBUSDT HOT Hourly, Round 1 (IS 2022/01-2026/01)
...
SEED_LEN, SEED_ATRL, SEED_MULT, SEED_RE = 20.0, 20.0, 3.0, 0.0  # LongLen, ShortLen, ATRMult, ReentryBars

PREFIX = "BNBDV_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_donchianasymv2_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_donchianasymv2_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_DonchianAsymV2_crypto on BNBUSDT HOT Hourly -- Round 1 (IS 2022/01-2026/01)")
    ...
    # static attempts (4D: LongLen x ShortLen x ATRMult x ReentryBars)
    _do(1, "01_global",       _cfg("01_global",       (5,80,15),  (20,300,40), (3,9,2),    (0,20,5)))   # seed the asym regime + cooldown
    _do(2, "02_asym_seed",    _cfg("02_asym_seed",    (10,30,5),  (150,300,25),(6,10,1),   (0,24,4)))   # DonchianAsym R1 corner + cooldown
    _do(3, "03_reentry_scan", _cfg("03_reentry_scan", (15,25,5),  (200,280,20),(7,9,0.5),  (0,40,4)))   # deep ReentryBars scan
    _do(4, "04_wide_trail",   _cfg("04_wide_trail",   (10,40,10), (100,300,50),(8,18,1),   (0,15,5)))   # wide trail x cooldown
    _do(5, "05_cooldown_deep",_cfg("05_cooldown_deep",(15,25,5),  (220,260,20),(7,9,1),    (0,100,5)))  # very deep cooldown
    _do(6, "06_short_both_cd",_cfg("06_short_both_cd",(5,50,5),   (5,50,5),    (3,7,2),    (0,30,10)))  # can cooldown rescue symmetric short?
    _do(7, "07_low_cooldown", _cfg("07_low_cooldown", (10,40,5),  (180,300,20),(6,10,1),   (0,4,2)))    # near-zero cooldown baseline
    _do(8, "08_long_long",    _cfg("08_long_long",    (40,200,40),(40,200,40), (4,10,2),   (0,20,5)))   # long both + cooldown
    _do(9, "09_mid_asym",     _cfg("09_mid_asym",     (10,30,2),  (200,280,20),(7.5,8.5,0.5),(0,12,3)))  # fine asym + cooldown
    ...
    log.info("==============================================================")
    log.info("  SFJ_DonchianAsymV2_crypto BNBUSDT Hourly Round-1 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_DonchianAsymV2_crypto BNBUSDT HOT Hourly R1 search")
