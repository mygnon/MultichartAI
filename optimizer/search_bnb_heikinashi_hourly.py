...
_LOG_FILE = OUTPUT_DIR / f"search_bnb_heikinashi_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_heikinashi_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_HeikinAshi_crypto on BNBUSDT HOT Hourly -- Round 1 (IS 2022/01-2026/01 chart-trimmed)")
    ...
    # static attempts
    _do(1, "01_global",      _cfg("01_global",      (1,40,2),  (1.5,10,0.5)))    # HASmooth x ATRMult
    _do(2, "02_fine_low",    _cfg("02_fine_low",    (1,20,1),  (2,6,0.25)))
    _do(3, "03_classic",     _cfg("03_classic",     (2,15,1),  (2.5,5,0.25)))
    _do(4, "04_wide_mult",   _cfg("04_wide_mult",   (2,20,2),  (4,16,0.5)))
    _do(5, "05_smooth_scan", _cfg("05_smooth_scan", (1,60,2),  (3,5,0.5)))
    _do(6, "06_mult_fine",   _cfg("06_mult_fine",   (3,12,1),  (1,12,0.25)))
    _do(7, "07_long_smooth", _cfg("07_long_smooth", (20,60,2), (2,8,0.5)))
    _do(8, "08_dense_low",   _cfg("08_dense_low",   (1,15,1),  (2,7,0.5)))
    ...
    log.info("==============================================================")
    log.info("  SFJ_HeikinAshi_crypto BNBUSDT Hourly Round-1 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_HeikinAshi_crypto BNBUSDT HOT Hourly R1 search")
