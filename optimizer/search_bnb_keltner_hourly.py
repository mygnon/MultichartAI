"""
search_bnb_keltner_hourly.py -- SFJ_KeltnerTrend_crypto on BNBUSDT HOT Hourly, Round 1 (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_keltner_hourly_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT = 20.0, 2.0, 3.0  # EMALen, BandMult, ATRMult

PREFIX = "BNBKEL_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_keltner_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_keltner_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_KeltnerTrend_crypto on BNBUSDT HOT Hourly -- Round 1 (IS 2022/01-2026/01)")
    ...
    # static attempts (3D)
    _do(1, "01_global_wide",  _cfg("01_global_wide",  (5,100,5),  (1,4,0.5),    (1.5,6.0,0.5)))   # EMA x Band x Trail
    _do(2, "02_default_zone", _cfg("02_default_zone", (10,40,2),  (1.5,3,0.25), (2.0,4.0,0.5)))
    _do(3, "03_ema_fine",     _cfg("03_ema_fine",     (5,60,2),   (1.5,2.5,0.5),(2.5,4.5,0.5)))
    _do(4, "04_band_fine",    _cfg("04_band_fine",    (15,35,5),  (0.5,5,0.25), (2.5,4.0,0.5)))
    _do(5, "05_mult_fine",    _cfg("05_mult_fine",    (15,35,5),  (1.5,3,0.5),  (1.0,8.0,0.25)))
    _do(6, "06_short_ema",    _cfg("06_short_ema",    (3,25,1),   (1,3,0.5),    (2.0,5.0,0.5)))
    _do(7, "07_long_ema",     _cfg("07_long_ema",     (40,150,5), (1.5,3,0.5),  (2.0,5.0,0.5)))
    _do(8, "08_wide_band",    _cfg("08_wide_band",    (10,50,5),  (0.5,4,0.5),  (1.0,10.0,0.5)))
    _do(9, "09_global_bound", _cfg("09_global_bound", (5,200,15), (0.5,6,0.5),  (1.0,9.0,1.0)))
    ...
    log.info("==============================================================")
    log.info("  SFJ_KeltnerTrend_crypto BNBUSDT Hourly Round-1 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
