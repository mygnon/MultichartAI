"""
search_bnb_qpatr_breakout_daily.py  QuantPassATR_Breakout on BNBUSDT HOT Daily, Round 1
...
Target: NP > 100,000 USD

Reference ceilings:
  QPATR_Breakout BTC Daily:  $2,544 NP-max / $1,830 Obj-max (Len=10-13 Mult=1.05-1.84)
  QPATR_Breakout ETH Daily:  $3,986 (Len=9 Mult=1.71, 9-conv)
  QPATR_Breakout BTC Hourly: $2,748 (Len=212 Mult=3.27)
  QPATR_Breakout ETH Hourly: $4,444 (Len=32 Mult=3.37)
  QPATR_Breakout BNB Hourly: $35,634 (Len=3 Mult=2.965, 13-conv)
  QPATRex BNB Daily:        $30,876 (Len=93 Su=0.37 Ni=0.53, 6-conv)
  QPATRex BNB Hourly:       $39,921 (Len=235 Su=0.58575 Ni=2.1275)

Predictions:
  Via BTC ratio: $2,544 x 12.97 = ~$33K
  Via QPATRex 0.85: $30,876 x 0.85 = ~$26K
  Via Hourly 0.85: $35,634 x 0.85 = ~$30K
  Expected: $26K-$33K (gap to $100K ~67-74%)

Attempt schedule (11 attempts, <=5000 combos each, 2D grids):
  Inspired by BTC/ETH Daily where short Len was champion.
  ...
  A07 Mult_below_1   Len(5-100 s2)   x Mult(0.1-1.0 s0.02)  [48x46=2208]
  A08 Mult_1_to_1.5  Len(5-100 s2)   x Mult(1.0-1.5 s0.01)  [48x51=2448]
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_qpatr_breakout_daily_search")
...
# BNB Hourly QPATR_Breakout champion as nominal seed
SEED_LEN  = 3.0
SEED_MULT = 2.965
SEED_NP   = 0.0
...
_LOG_FILE = OUTPUT_DIR / f"search_bnb_qpatr_breakout_daily_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    payload = {
        ...
        "notes": {
            ...
            "reference": "BNB Hourly $35,634 (Len=3 Mult=2.965); BTC Daily $2,544; ETH Daily $3,986; QPATRex BNB Daily $30,876",
        },
        "best_params":  best_entry,
        "all_attempts": attempt_log,
    }
    out = OUTPUT_DIR / "final_params_bnb_qpatr_breakout_daily.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  QuantPassATR_Breakout on BNBUSDT HOT Daily -- Round 1")
    log.info("  Target: %.0f USD", TARGET_NP)
    log.info("  BNB Hourly: Len=3 Mult=2.965 NP=$35,634 (13-conv)")
    log.info("  Expected: $26K-$33K (gap to $100K ~67-74%)")
    log.info("==============================================================")
    ...
    log.info("==============================================================")
    log.info("  QuantPassATR_Breakout BNBUSDT Daily Round-1 COMPLETE")
...
def main():
    parser = argparse.ArgumentParser(
        description="QuantPassATR_Breakout BNBUSDT HOT Daily R1 parameter search")
