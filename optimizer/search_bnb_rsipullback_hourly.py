"""
search_bnb_rsipullback_hourly.py -- SFJ_RSIPullback_crypto on BNBUSDT HOT Hourly, R1 (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_rsipullback_hourly_search")
...
SEED_TR, SEED_RL, SEED_TH, SEED_MULT = 100.0, 14.0, 40.0, 3.0

PREFIX = "BNBRSIP_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_rsipullback_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_rsipullback_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_RSIPullback_crypto on BNBUSDT HOT Hourly -- Round 1 (IS 2022/01-2026/01)")
    ...
    # static attempts (4D)
    _do(1, "01_global",      _cfg("01_global",      (20,200,20),(7,21,7),  (20,60,10),(2,5,1)))
    _do(2, "02_default",     _cfg("02_default",     (50,150,20),(10,20,2), (30,50,5), (2,4,0.5)))
    _do(3, "03_trend_fine",  _cfg("03_trend_fine",  (20,300,20),(10,18,4), (35,45,5), (2.5,4,0.5)))
    _do(4, "04_rsilen_fine", _cfg("04_rsilen_fine", (80,120,20),(4,30,2),  (30,50,5), (2.5,4,0.5)))
    _do(5, "05_thresh_fine", _cfg("05_thresh_fine", (80,120,20),(10,18,4), (15,55,2), (2.5,4,0.5)))
    _do(6, "06_mult_fine",   _cfg("06_mult_fine",   (60,140,20),(10,18,4), (30,50,10),(1,8,0.25)))
    _do(7, "07_short_trend", _cfg("07_short_trend", (10,60,5),  (8,16,4),  (25,50,5), (2,5,1)))
    _do(8, "08_deep_pull",   _cfg("08_deep_pull",   (50,150,25),(10,20,5), (10,40,5), (2,6,1)))
    _do(9, "09_global_bound",_cfg("09_global_bound",(20,400,40),(5,35,10), (20,60,10),(1,9,2)))
    ...
    for A, nm_, (rT_mul, rT_min, rR_mul, rR_min, rH_mul, rH_min, rM_mul, rM_min, nT, nR, nH, nM) in [
        ...
        if start_attempt <= A:
            ...
            _R = zoom_fixed(sR, max(rR_min, sR * rR_mul), nR, 1.0,  RL_LO,   RL_HI)
    ...
    log.info("==============================================================")
    log.info("  SFJ_RSIPullback_crypto BNBUSDT Hourly Round-1 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
