"""
search_bnb_supertrend_daily.py — SFJ_SuperTrend_crypto on BNBUSDT HOT Daily, Round 1
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_supertrend_daily_search")
...
_LOG_FILE = OUTPUT_DIR / f"search_bnb_supertrend_daily_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    payload = {
        ...
        "notes": {
            ...
            "priors":   "SuperTrend Hourly BNB/BTC/ETH ATR 45-151 Mult 6.6-10.45; Daily uses much shorter ATR. SuperTrend default ATRLength=10 Mult=3; BNB Daily other strategies ~$3.5K",
            "r1_plan":  "global + short/mid/long/vlong ATR + low/high mult + fine-default + adaptive zoom",
        },
        "best_params":  best_entry,
        "all_attempts": attempt_log,
    }
    out = OUTPUT_DIR / "final_params_bnb_supertrend_daily.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  BNB Daily SFJ_SuperTrend_crypto NP>100K -- Round 1")
    ...
    log.info("==============================================================")
    log.info("  BNB Daily SuperTrend_crypto Round-1 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="BNB Daily SFJ_SuperTrend_crypto NP>100K Round-1 search")
