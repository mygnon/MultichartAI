"""
search_bnb_supertrend_hourly.py — SFJ_SuperTrend_crypto on BNBUSDT HOT Hourly, Round 1
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_supertrend_hourly_search")
...
_LOG_FILE = OUTPUT_DIR / f"search_bnb_supertrend_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_supertrend_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  BNB Hourly SFJ_SuperTrend_crypto NP>100K -- Round 1")
    ...
    log.info("==============================================================")
    log.info("  BNB Hourly SuperTrend_crypto Round-1 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="BNB Hourly SFJ_SuperTrend_crypto NP>100K Round-1 search")
