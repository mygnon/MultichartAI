"""
search_bnb_volatilitybreakout_hourly.py -- SFJ_VolatilityBreakout_crypto on BNBUSDT HOT Hourly, Round 1 (IS 2022/01-2026/01)
...
ATRL_LO, ATRL_HI = 0.1,  5.0    # EntryMult
MULT_LO, MULT_HI = 0.5,  20.0   # TrailMult

SEED_LEN, SEED_ATRL, SEED_MULT = 14.0, 1.0, 3.0  # ATRLen, EntryMult, TrailMult

PREFIX = "BNBVB_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_volatilitybreakout_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_volatilitybreakout_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    # static attempts (3D)
    _do(1, "01_global_wide",  _cfg("01_global_wide",  (5,100,5),  (0.5,3,0.5),   (1.5,8.0,0.5)))   # ATRLen x EntryMult x TrailMult
    _do(2, "02_default_zone", _cfg("02_default_zone", (10,30,2),  (0.5,2,0.25),  (2.0,6.0,0.5)))
    _do(3, "03_atrlen_fine",  _cfg("03_atrlen_fine",  (5,60,2),   (0.75,1.5,0.25),(3.0,8.0,0.5)))
    _do(4, "04_entry_fine",   _cfg("04_entry_fine",   (10,30,5),  (0.1,3,0.1),   (3.0,6.0,0.5)))
    _do(5, "05_trail_fine",   _cfg("05_trail_fine",   (10,30,5),  (0.5,1.5,0.25),(1.0,12.0,0.25)))
    _do(6, "06_short_atrlen", _cfg("06_short_atrlen", (2,20,1),   (0.5,2,0.5),   (2.0,8.0,0.5)))
    _do(7, "07_long_atrlen",  _cfg("07_long_atrlen",  (40,150,5), (0.5,2,0.5),   (2.0,8.0,0.5)))
    _do(8, "08_wide_trail",   _cfg("08_wide_trail",   (10,60,5),  (0.5,2.5,0.5), (4.0,16.0,0.5)))
    _do(9, "09_global_bound", _cfg("09_global_bound", (5,200,15), (0.25,4,0.5),  (1.0,12.0,1.0)))
    ...
    log.info("==============================================================")
    log.info("  SFJ_VolatilityBreakout_crypto BNBUSDT Hourly Round-1 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
