"""
search_bnb_xtreme_hourly.py — SFJ_XtremeStop_Crypto on BNBUSDT HOT Hourly, Round 1
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_xtreme_hourly_search")
...
_LOG_FILE = OUTPUT_DIR / f"search_bnb_xtreme_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_xtreme_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  BNB Hourly SFJ_XtremeStop_Crypto NP>100K -- Round 1")
    ...
    log.info("==============================================================")
    log.info("  BNB Hourly XtremeStop_Crypto Round-1 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="BNB Hourly SFJ_XtremeStop_Crypto NP>100K Round-1 search")
