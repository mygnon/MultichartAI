"""
search_bnb_xtreme_hourly2.py — SFJ_XtremeStop_Crypto on BNBUSDT HOT Hourly, Round 2
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\bnb_xtreme_hourly2_search")
...
SEED_X, SEED_LY, SEED_SY = 788.0, 2.35, 8.75
SEED_NP = 0.0

PREFIX = "BNBXTH2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_bnb_xtreme_hourly2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_bnb_xtreme_hourly2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  BNB Hourly SFJ_XtremeStop_Crypto NP>100K -- Round 2")
    log.info("  IS window %s ~ %s  (chart-trimmed)", IS_RANGE[0], IS_RANGE[1])
    log.info("  R1 champ X=788 LY=2.35 SY=8.75 NP=26081 (long-X asym SY-high; confirming/pushing X)", )
    log.info("==============================================================")

    if not from_csv and conn is not None:
        mc.ensure_chart_ready(conn, _cfg("seed", (770, 810, 10), (2.0, 2.75, 0.25), (8.0, 9.5, 0.25)))
    ...
    attempts_config = [
        ("01_X_push_long",   (700, 2000, 80), (1.5, 4.0, 0.5),  (6.0, 12.0, 0.5)),
        ("02_X_vlong",       (1500, 4000, 150),(1.5, 4.0, 0.5), (6.0, 12.0, 1.0)),
        ("03_asym_refine",   (600, 1000, 25), (1.5, 4.0, 0.25), (6.0, 11.0, 0.5)),
        ("04_SY_sweep",      (700, 900, 20),  (2.0, 3.0, 0.25), (5.0, 15.0, 0.5)),
        ("05_LY_sweep",      (700, 900, 20),  (0.5, 6.0, 0.25), (8.0, 9.5, 0.25)),
        ("06_X_mid_recheck", (300, 700, 25),  (1.5, 4.0, 0.5),  (6.0, 12.0, 0.5)),
        ("07_sym_longX",     (600, 1200, 50), (3.0, 10.0, 0.5), (3.0, 10.0, 0.5)),
        ("08_short_X_redo",  (2, 60, 3),      (1.0, 8.0, 0.5),  (4.0, 12.0, 1.0)),
    ]
    ...
    log.info("==============================================================")
    log.info("  BNB Hourly XtremeStop_Crypto Round-2 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="BNB Hourly SFJ_XtremeStop_Crypto NP>100K Round-2 search")
