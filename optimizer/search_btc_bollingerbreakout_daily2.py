"""
search_btc_bollingerbreakout_daily.py -- SFJ_BollingerBreakout_crypto on BTCUSDT HOT Daily, Round 2 confirm (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\btc_bollingerbreakout_daily_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT, SEED_RE = 5.0, 2.86, 4.37, 4.0  # BBLen, BBmult, ATRMult, ReentryBars (R1 A11 Obj-max)

PREFIX = "BTCBOD_R2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_btc_bollingerbreakout_daily2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    payload = {
        "round": 2, "strategy": SIGNAL, "symbol": SYMBOL, "timeframe": "Daily",
    ...
    out = OUTPUT_DIR / "final_params_btc_bollingerbreakout_daily2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto on BTCUSDT HOT Daily -- Round 2 confirm (IS 2022/01-2026/01; seed R1 5/2.86/4.37/4, sparse 10-14tr)")
    ...
    # R2 confirm around R1 A11 Obj-max: BBLen=5 BBmult=2.86 ATRMult=4.37 ReentryBars=4 (DAILY, sparse 10-14tr)
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (4,6,1),    (2.7,3.0,0.1), (4.0,4.75,0.25),(3,5,1)))   # Rule 5 baseline
    _do(2, "02_bblen_fine",   _cfg("02_bblen_fine",   (2,12,1),   (2.7,3.0,0.1), (4.0,4.75,0.25),(2,6,2)))   # nail BBLen 2-12
    _do(3, "03_bbmult_fine",  _cfg("03_bbmult_fine",  (4,6,1),    (2.0,3.5,0.05),(4.0,4.75,0.25),(3,5,1)))   # nail BBmult 2.0-3.5
    _do(4, "04_atrmult_fine", _cfg("04_atrmult_fine", (4,6,1),    (2.7,3.0,0.1), (3.0,7.0,0.25),(3,5,1)))    # nail ATRMult 3-7
    _do(5, "05_atrmult_wide", _cfg("05_atrmult_wide", (4,6,1),    (2.7,3.0,0.1), (5.0,12.0,0.5),(2,6,2)))    # wider trail check
    _do(6, "06_reentry_fine", _cfg("06_reentry_fine", (4,6,1),    (2.7,3.0,0.1), (4.0,4.75,0.25),(0,20,1)))  # nail ReentryBars 0-20
    _do(7, "07_bblen_short",  _cfg("07_bblen_short",  (2,8,1),    (2.5,3.5,0.1), (3.5,5.0,0.25),(2,6,1)))    # short BBLen alt
    _do(8, "08_combo_tight",  _cfg("08_combo_tight",  (3,7,1),    (2.6,3.1,0.05),(4.0,5.0,0.25),(3,5,1)))    # tight combo at peak
    _do(9, "09_bbmult_low",   _cfg("09_bbmult_low",   (4,6,1),    (1.0,2.6,0.2), (4.0,4.75,0.25),(3,5,1)))   # check BBmult below 2.86
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto BTCUSDT Daily Round-2 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_BollingerBreakout_crypto BTCUSDT HOT Daily R2 confirm")
