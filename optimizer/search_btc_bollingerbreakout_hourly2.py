"""
search_btc_bollingerbreakout_hourly.py -- SFJ_BollingerBreakout_crypto on BTCUSDT HOT Hourly, Round 2 confirm (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\btc_bollingerbreakout_hourly_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT, SEED_RE = 8.0, 1.61, 13.36, 23.0  # BBLen, BBmult, ATRMult, ReentryBars (R1 A12 best)

PREFIX = "BTCBO_R2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_btc_bollingerbreakout_hourly2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_btc_bollingerbreakout_hourly2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto on BTCUSDT HOT Hourly -- Round 2 confirm (IS 2022/01-2026/01; seed R1 8/1.61/13.4/23)")
    ...
    # R2 confirmation around R1 A12 best: BBLen=8 BBmult=1.61 ATRMult=13.4 ReentryBars=23
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (7,9,1),    (1.5,1.7,0.1), (13,14,0.5), (22,24,1)))   # Rule 5 baseline
    _do(2, "02_bblen_fine",   _cfg("02_bblen_fine",   (4,16,1),   (1.5,1.7,0.1), (13,14,0.5), (21,25,2)))   # nail BBLen 4-16
    _do(3, "03_bbmult_fine",  _cfg("03_bbmult_fine",  (6,10,1),   (1.2,2.1,0.05),(13,14,0.5), (22,24,1)))   # nail BBmult 1.2-2.1
    _do(4, "04_atrmult_fine", _cfg("04_atrmult_fine", (6,10,1),   (1.5,1.7,0.1), (10,18,0.5), (22,24,1)))   # nail ATRMult 10-18
    _do(5, "05_atrmult_high", _cfg("05_atrmult_high", (6,10,2),   (1.5,1.7,0.1), (14,20,0.5), (20,26,2)))   # push ATRMult toward 20
    _do(6, "06_reentry_fine", _cfg("06_reentry_fine", (6,10,2),   (1.5,1.7,0.1), (13,14,0.5), (10,40,2)))   # nail ReentryBars 10-40
    _do(7, "07_bblen_low",    _cfg("07_bblen_low",    (2,12,1),   (1.4,1.8,0.1), (12,15,0.5), (20,26,2)))   # check BBLen below 8
    _do(8, "08_combo_tight",  _cfg("08_combo_tight",  (6,11,1),   (1.5,1.75,0.05),(12.5,14.5,0.5),(21,25,1)))# tight combo at peak
    _do(9, "09_bbmult_low",   _cfg("09_bbmult_low",   (6,10,1),   (1.0,1.6,0.1), (13,14,0.5), (22,24,1)))   # check BBmult below 1.61
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto BTCUSDT Hourly Round-2 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_BollingerBreakout_crypto BTCUSDT HOT Hourly R2 confirm")
