"""
search_btc_closechannelbreakout_hourly2.py -- SFJ_CloseChannelBreakout_crypto on BTCUSDT HOT Hourly, Round 1 (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\btc_closechannelbreakout_hourly2_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT = 7.0, 8.0, 18.0  # R2 seed = R1 Obj-max champion

PREFIX = "BTCCCB2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_btc_closechannelbreakout_hourly2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_btc_closechannelbreakout_hourly2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_VolatilityBreakout_crypto on BTCUSDT HOT Hourly -- Round 1 (IS 2022/01-2026/01)")
    ...
    # static attempts (3D)
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (5,9,1),    (7.0,9.0,0.5),  (16,20,1)))   # Rule-5 + tight box (incl 7/8/18)
    _do(2, "02_length_fine",  _cfg("02_length_fine",  (2,20,1),   (7.5,8.5,0.5),  (17,19,1)))
    _do(3, "03_atrmult_fine", _cfg("03_atrmult_fine", (5,9,1),    (5.0,12.0,0.25),(17,19,1)))
    _do(4, "04_reentry_fine", _cfg("04_reentry_fine", (5,9,1),    (7.5,8.5,0.5),  (0,30,1)))
    _do(5, "05_npmax_check",  _cfg("05_npmax_check",  (3,9,1),    (8.0,12.0,0.5), (16,20,1)))
    _do(6, "06_wide_trail",   _cfg("06_wide_trail",   (5,12,1),   (8.0,20.0,0.5), (10,20,2)))
    _do(7, "07_short_len",    _cfg("07_short_len",    (2,12,1),   (6.0,10.0,0.5), (12,22,2)))
    _do(8, "08_combo_2d",     _cfg("08_combo_2d",     (4,12,1),   (7.0,9.0,0.25), (14,22,1)))
    _do(9, "09_atrmult_low",  _cfg("09_atrmult_low",  (5,9,1),    (0.5,7.0,0.5),  (16,20,1)))
    ...
    log.info("==============================================================")
    log.info("  SFJ_CloseChannelBreakout_crypto BTCUSDT Hourly Round-2 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_VolatilityBreakout_crypto BTCUSDT HOT Hourly R1 search")
