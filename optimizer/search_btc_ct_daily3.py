"""
search_btc_ct_daily3.py — SFJ_15Dworkshop_lesson5_countertrend_LS_crypto on BTCUSDT HOT Daily, Round 3

R1+R2 Summary (22 attempts):
  Champion ⭐ 7-conv (R1 A10/A11 + R2 A01/A03/A04/A10/A11):
    LL=49 SL=2.4 LS=123 SS=1.2 NP=$3,592.66 MDD=-$398.78 16tr Obj=32,366
  R1→R2 +0.00%.  R1 export-fails redone, all worse: long_period $1,824, asym $2,586,
    high_stddev sparse $462.  LS bridge 100-160 confirmed LS=123 from below.
  Gap to $10K -64.1%.

R3 Plan (11 attempts, <=5000 combos each) — FINAL: close the LS>160 gap
  (the same gap that broke BTC HOURLY's false ceiling: LS 145-220 found LS=165).
  A01 LS_130_220_bridge  LL(43-55 s2)xSL(2.2-2.6 s0.1)xLS(130-220 s5)xSS(1.0-1.4 s0.1)   = 2793
  A02 LS_220_340         LL(43-55 s3)xSL(2.2-2.6 s0.1)xLS(220-340 s10)xSS(1.0-1.4 s0.1)   = 1625
  A03 champion_ultrafine LL(47-51 s1)xSL(2.35-2.45 s0.025)xLS(121-125 s1)xSS(1.15-1.25 s0.025) = 375
  A04 longLL_longLS      LL(49-90 s4)xSL(2.0-2.8 s0.1)xLS(120-180 s5)xSS(1.0-1.5 s0.1)     = 3289
  A05 high_stddev_retry  LL(30-70 s8)xSL(3.0-5.0 s0.25)xLS(30-130 s10)xSS(1.5-3.0 s0.5)    = 3168
  A06 LS_160_260_SSfine  LL(45-53 s4)xSL(2.2-2.6 s0.1)xLS(160-260 s5)xSS(0.8-1.6 s0.1)     = 3213
  A07 ultrashort_LL      LL(2-30 s2)xSL(1.5-3.0 s0.25)xLS(100-150 s10)xSS(1.0-1.5 s0.25)   = 1680
  A08 global_verify      LL(20-120 s10)xSL(1.5-3.5 s0.25)xLS(40-200 s20)xSS(0.8-2.0 s0.3)  = 4455
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\btc_ct_daily3_search")
...
_LOG_FILE = OUTPUT_DIR / f"search_btc_ct_daily3_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    payload = {
        ...
        "notes": {
            ...
            "r2_result": "R1+R2 champion 7-conv: LL=49 SL=2.4 LS=123 SS=1.2 NP=$3,593 MDD=-$399 16tr Obj=32,366; R1->R2 +0.00%; redos all worse",
            "r3_plan":  "Close LS>160 gap (broke Hourly false ceiling): LS 130-220/220-340 bridges + champion ultrafine + longLL-longLS corner + high_stddev retry + LS 160-260 SSfine + ultrashort LL + global verify + adaptive zoom",
        },
        "best_params":  best_entry,
        "all_attempts": attempt_log,
    }
    out = OUTPUT_DIR / "final_params_btc_ct_daily3.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  BTC Daily countertrend_LS_crypto NP>10K -- Round 3 (close LS>160 gap)")
    log.info("  Champion 7-conv: LL=49 SL=2.4 LS=123 SS=1.2 NP=$3,593 Obj=32,366")
    log.info("==============================================================")
    ...
    attempts_config = [
        ("01_LS_130_220_bridge",    (43, 55, 2),    (2.2, 2.6, 0.1),    (130, 220, 5),   (1.0, 1.4, 0.1)),
        ("02_LS_220_340",           (43, 55, 3),    (2.2, 2.6, 0.1),    (220, 340, 10),  (1.0, 1.4, 0.1)),
        ("03_champion_ultrafine",   (47, 51, 1),    (2.35, 2.45, 0.025),(121, 125, 1),   (1.15, 1.25, 0.025)),
        ("04_longLL_longLS",        (49, 90, 4),    (2.0, 2.8, 0.1),    (120, 180, 5),   (1.0, 1.5, 0.1)),
        ("05_high_stddev_retry",    (30, 70, 8),    (3.0, 5.0, 0.25),   (30, 130, 10),   (1.5, 3.0, 0.5)),
        ("06_LS_160_260_SSfine",    (45, 53, 4),    (2.2, 2.6, 0.1),    (160, 260, 5),   (0.8, 1.6, 0.1)),
        ("07_ultrashort_LL",        (2, 30, 2),     (1.5, 3.0, 0.25),   (100, 150, 10),  (1.0, 1.5, 0.25)),
        ("08_global_verify",        (20, 120, 10),  (1.5, 3.5, 0.25),   (40, 200, 20),   (0.8, 2.0, 0.3)),
    ]
    ...
    log.info("==============================================================")
    log.info("  BTC Daily countertrend_LS_crypto Round-3 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="BTC Daily countertrend_LS_crypto NP>10K Round-3 search")
