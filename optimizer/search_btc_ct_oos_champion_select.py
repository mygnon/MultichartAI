...
# 9 converged champions (NP-max C1-C5 verified == results/btc_ct_hourly{,2..5}_search best_params).
# id, regime, LL, SL, LS, SS, prior IS NP, prior IS MDD (= MCReport Max Intraday DD)
CANDIDATES = [
    ("C1", "NP-max R1",         107.0, 4.10,  139.0, 4.70, 4104.0, -799.0),
    ("C2", "NP-max R2",         104.0, 4.05,  140.0, 4.70, 4125.0, -799.0),
    ("C3", "NP-max R3",         104.0, 4.05,  139.0, 4.65, 4125.0, -799.0),
    ("C4", "NP-max R4",         105.0, 4.075, 165.0, 4.95, 4155.0, -498.0),
    ("C5", "NP-max R5 *",       104.0, 4.05,  165.0, 4.95, 4155.0, -498.0),
    ("C6", "Obj-max R1",        110.0, 4.00,  140.0, 5.00, 3754.0, -504.0),
    ("C7", "Obj-max R2",         95.0, 4.50,   70.0, 5.00, 3799.0, -490.0),
    ("C8", "Obj-max R3",        105.0, 4.20,   68.0, 4.90, 3991.0, -464.0),
    ("C9", "Obj-max R4/R5 ***", 104.0, 4.15,   68.0, 4.95, 4093.0, -431.0),
]
