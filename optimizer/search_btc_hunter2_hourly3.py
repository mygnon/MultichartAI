"""
search_btc_hunter2_hourly3.py — SFJ_HUNTER2_crypto on BTCUSDT HOT Hourly, Round 3 (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\btc_hunter2_hourly3_search")
...
# Round-3 has no prior champion — seed from strategy defaults
SEED_LL   = 250.0
SEED_LS   = 800.0
SEED_ATRL = 4.5
SEED_ATRS = 2.5
...
_LOG_FILE = OUTPUT_DIR / f"search_btc_hunter2_hourly3_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_btc_hunter2_hourly3.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("══════════════════════════════════════════════════════════════")
    log.info("  SFJ_HUNTER2_crypto on BTCUSDT HOT Hourly — Round 3 (IS 2022/01-2026/01 chart-trimmed)")
    ...
    A = 1
    _n = "01_LEN_S_push"
    _c = _cfg(_n, (200, 350, 25), (700, 1500, 100), (3.5, 6.0, 0.5), (1.5, 3.0, 0.5))
    ...
    A = 2
    _n = "02_LEN_L_sweep"
    _c = _cfg(_n, (150, 450, 25), (750, 900, 25), (4.0, 5.5, 0.25), (1.5, 2.5, 0.25))
    ...
    A = 3
    _n = "03_ATR_refine"
    _c = _cfg(_n, (240, 280, 10), (780, 850, 10), (3.5, 6.0, 0.25), (1.0, 3.0, 0.25))
    ...
    A = 4
    _n = "04_vlong_LEN_S"
    _c = _cfg(_n, (200, 300, 25), (1000, 2000, 100), (4.0, 5.5, 0.5), (1.5, 3.0, 0.5))
    ...
    A = 5
    _n = "05_fine_zoom_A04"
    _c = _cfg(_n, (240, 260, 5), (780, 820, 10), (4.25, 4.75, 0.1), (1.75, 2.25, 0.1))
    ...
    A = 6
    _n = "06_ATR_S_low"
    _c = _cfg(_n, (240, 280, 20), (750, 900, 50), (4.0, 5.0, 0.25), (0.5, 2.5, 0.25))
    ...
    # ──────────────────────────────────────────────────────────────────────
    A = 7
    _n = "07_high_atr_reconfirm"
    _c = _cfg(_n, (110, 140, 10), (180, 220, 10), (3.0, 5.0, 0.5), (10.0, 14.0, 0.5))
    ...
    A = 8
    _n = "08_mid_ultralong"
    _c = _cfg(_n, (100, 250, 30), (600, 1200, 100), (3.0, 6.0, 0.5), (1.5, 3.5, 0.5))
    ...
    # ──────────────────────────────────────────────────────────────────────
    log.info("══════════════════════════════════════════════════════════════")
    log.info("  SFJ_HUNTER2_crypto BTCUSDT HOT Hourly Round-3 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="SFJ_HUNTER2_crypto BTCUSDT HOT Hourly NP>100K USD Round-3 search")
