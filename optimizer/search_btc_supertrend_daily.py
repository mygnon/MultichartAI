"""
search_btc_supertrend_daily.py — SFJ_SuperTrend_crypto on BTCUSDT HOT Daily, Round 1
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\btc_supertrend_daily_search")
...
_LOG_FILE = OUTPUT_DIR / f"search_btc_supertrend_daily_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    payload = {
        ...
        "notes": {
            ...
            "priors":   "SuperTrend Hourly BNB/BTC/ETH ATR 45-151 Mult 6.6-10.45; Daily uses much shorter ATR. SuperTrend default ATRLength=10 Mult=3; BTC Daily other strategies ~$3.5K",
            "r1_plan":  "global + short/mid/long/vlong ATR + low/high mult + fine-default + adaptive zoom",
        },
        "best_params":  best_entry,
        "all_attempts": attempt_log,
    }
    out = OUTPUT_DIR / "final_params_btc_supertrend_daily.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  BTC Daily SFJ_SuperTrend_crypto NP>100K -- Round 1")
    ...
    attempts_config = [
        ("01_global_coarse", (2, 120, 2),    (0.5, 10.0, 0.25)),
        ("02_short_ATR",     (1, 40, 1),     (0.5, 8.0, 0.25)),
        ("03_mid_ATR",       (20, 100, 2),   (1.0, 6.0, 0.125)),
        ("04_long_ATR",      (80, 300, 5),   (1.0, 6.0, 0.25)),
        ("05_low_mult",      (2, 120, 2),    (0.3, 3.0, 0.1)),
        ("06_high_mult",     (2, 120, 2),    (4.0, 12.0, 0.25)),
        ("07_vlong_ATR",     (150, 500, 10), (1.0, 6.0, 0.25)),
        ("08_fine_default",  (2, 40, 1),     (1.5, 6.0, 0.125)),
    ]
    ...
    log.info("==============================================================")
    log.info("  BTC Daily SuperTrend_crypto Round-1 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="BTC Daily SFJ_SuperTrend_crypto NP>100K Round-1 search")
