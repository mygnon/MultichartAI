"""
search_btc_xtreme_daily.py — SFJ_XtremeStop_Crypto on BTCUSDT HOT Daily, Round 1
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\btc_xtreme_daily_search")
...
_LOG_FILE = OUTPUT_DIR / f"search_btc_xtreme_daily_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_btc_xtreme_daily.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  BTC Daily SFJ_XtremeStop_Crypto NP>100K -- Round 1 (FIRST crypto Daily)")
    ...
    log.info("==============================================================")
    log.info("  BTC Daily XtremeStop_Crypto Round-1 COMPLETE")
