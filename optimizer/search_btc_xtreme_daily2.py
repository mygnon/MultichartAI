"""
search_btc_xtreme_daily2.py — SFJ_XtremeStop_Crypto on BTCUSDT HOT Daily, Round 1
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\btc_xtreme_daily2_search")
...
# First crypto XtremeStop Daily — seed at a short-X point (daily futures priors X=1-9)
SEED_X, SEED_LY, SEED_SY = 268.0, 2.3, 0.1
SEED_NP = 4020.6

PREFIX = "BTCXTD2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_btc_xtreme_daily2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_btc_xtreme_daily2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  BTC Daily SFJ_XtremeStop_Crypto NP>100K -- Round 2 (confirm R1 X=268 LY=2.3 SY=0.1)")
    ...
    if not from_csv and conn is not None:
        mc.ensure_chart_ready(conn, _cfg("seed", (264, 272, 2), (2.0, 2.6, 0.1), (0.1, 0.5, 0.1)))
    ...
    attempts_config = [
        ("01_retest_seed",  (264, 272, 2),  (1.9, 2.7, 0.1),  (0.1, 0.9, 0.1)),   # 5*9*9=405  Rule-5
        ("02_SY_floor",     (264, 272, 2),  (2.0, 2.6, 0.1),  (0.1, 2.0, 0.1)),   # 5*7*20=700 verify SY floor
        ("03_X_sweep",      (200, 340, 4),  (2.0, 2.6, 0.1),  (0.1, 0.3, 0.1)),   # 36*7*3=756
        ("04_LY_fine",      (264, 272, 2),  (1.0, 3.5, 0.1),  (0.1, 0.3, 0.1)),   # 5*26*3=390
        ("05_X_wide",       (150, 500, 10), (2.0, 2.6, 0.2),  (0.1, 0.5, 0.1)),   # 36*4*5=720
        ("06_dense_recheck",(20, 60, 2),    (0.5, 3.0, 0.25), (0.2, 1.0, 0.2)),   # 21*11*5=1155 dense low-MDD regime
        ("07_SY_push_wide", (240, 300, 5),  (2.0, 2.6, 0.1),  (0.1, 4.0, 0.25)),  # 13*7*16=1456
        ("08_combo_2d",     (230, 320, 6),  (1.8, 3.0, 0.2),  (0.1, 0.6, 0.1)),   # 16*7*6=672
    ]
    ...
    log.info("==============================================================")
    log.info("  BTC Daily XtremeStop_Crypto Round-2 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="BTC Daily SFJ_XtremeStop_Crypto NP>100K Round-1 search")
