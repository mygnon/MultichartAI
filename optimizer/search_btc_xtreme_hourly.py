"""
search_btc_xtreme_hourly.py — SFJ_XtremeStop_Crypto on BTCUSDT HOT Hourly, Round 1
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\btc_xtreme_hourly_search")
...
SEED_X, SEED_LY, SEED_SY = 150.0, 3.25, 3.25
SEED_NP = 0.0

PREFIX = "BTCXTH1_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_btc_xtreme_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_btc_xtreme_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  BTC Hourly SFJ_XtremeStop_Crypto NP>100K -- Round 1")
    ...
    if not from_csv and conn is not None:
        mc.ensure_chart_ready(conn, _cfg("seed", (140, 160, 10), (3.0, 3.5, 0.25), (3.0, 3.5, 0.25)))
    ...
    attempts_config = [
        ("01_global_coarse", (5, 305, 30),    (0.5, 8.0, 0.5),  (0.5, 8.0, 0.5)),
        ("02_short_X",       (1, 50, 3),      (0.5, 7.0, 0.5),  (0.5, 7.0, 0.5)),
        ("03_mid_X",         (80, 300, 20),   (1.0, 8.0, 0.5),  (1.0, 8.0, 0.5)),
        ("04_long_X",        (300, 1000, 50), (1.0, 8.0, 0.5),  (1.0, 8.0, 0.5)),
        ("05_high_pct",      (5, 305, 30),    (5.0, 15.0, 0.5), (5.0, 15.0, 0.5)),
        ("06_low_pct",       (5, 205, 20),    (0.2, 3.0, 0.2),  (0.2, 3.0, 0.2)),
        ("07_asym_LY_high",  (10, 160, 15),   (2.0, 12.0, 0.5), (0.5, 5.0, 0.5)),
        ("08_asym_SY_high",  (10, 160, 15),   (0.5, 5.0, 0.5),  (2.0, 12.0, 0.5)),
    ]
    ...
    log.info("==============================================================")
    log.info("  BTC Hourly XtremeStop_Crypto Round-1 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="BTC Hourly SFJ_XtremeStop_Crypto NP>100K Round-1 search")
