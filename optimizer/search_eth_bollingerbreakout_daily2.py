"""
search_eth_bollingerbreakout_daily.py -- SFJ_BollingerBreakout_crypto on ETHUSDT HOT Daily, Round 2 confirm (IS 2022/01-2026/01)
...
SEED_LEN, SEED_ATRL, SEED_MULT, SEED_RE = 10.0, 2.5, 2.75, 15.0  # BBLen, BBmult, ATRMult, ReentryBars (R1 A11 best)

PREFIX = "ETHBOD_R2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_eth_bollingerbreakout_daily2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_eth_bollingerbreakout_daily2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto on ETHUSDT HOT Daily -- Round 2 confirm (IS 2022/01-2026/01; seed R1 10/2.5/2.75/15)")
    ...
    # R2 confirmation around R1 A11 best: BBLen=10 BBmult=2.5 ATRMult=2.75 ReentryBars=15 (DAILY units)
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (9,11,1),   (2.4,2.6,0.1), (2.5,3.0,0.25),(14,16,1)))  # Rule 5 baseline
    _do(2, "02_bblen_fine",   _cfg("02_bblen_fine",   (2,20,1),   (2.4,2.6,0.1), (2.5,3.0,0.25),(13,17,2)))  # nail BBLen 2-20
    _do(3, "03_bbmult_fine",  _cfg("03_bbmult_fine",  (8,12,1),   (1.5,3.5,0.1), (2.5,3.0,0.25),(14,16,1)))  # nail BBmult 1.5-3.5
    _do(4, "04_atrmult_fine", _cfg("04_atrmult_fine", (8,12,1),   (2.4,2.6,0.1), (1.5,5.0,0.25),(14,16,1)))  # nail ATRMult 1.5-5
    _do(5, "05_atrmult_wide", _cfg("05_atrmult_wide", (8,12,2),   (2.4,2.6,0.1), (3.0,9.0,0.5), (13,17,2)))  # wider trail check
    _do(6, "06_reentry_fine", _cfg("06_reentry_fine", (8,12,2),   (2.4,2.6,0.1), (2.5,3.0,0.25),(0,30,1)))   # nail ReentryBars 0-30
    _do(7, "07_bblen_short",  _cfg("07_bblen_short",  (2,15,1),   (2.5,3.5,0.25),(2.5,3.5,0.25),(8,16,2)))   # short BBLen alt regime
    _do(8, "08_combo_tight",  _cfg("08_combo_tight",  (8,13,1),   (2.3,2.8,0.1), (2.5,3.25,0.25),(13,16,1))) # tight combo at peak
    _do(9, "09_bbmult_low",   _cfg("09_bbmult_low",   (8,12,1),   (0.8,2.4,0.2), (2.5,3.0,0.25),(14,16,1)))  # check BBmult below 2.5
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto ETHUSDT Daily Round-2 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_BollingerBreakout_crypto ETHUSDT HOT Daily R2 confirm")
