"""
search_eth_bollingerbreakout_daily.py -- SFJ_BollingerBreakout_crypto on ETHUSDT HOT Daily, Round 3 BBmult confirm (IS 2022/01-2026/01)
...
SEED_LEN, SEED_ATRL, SEED_MULT, SEED_RE = 10.0, 1.4, 3.0, 14.0  # BBLen, BBmult, ATRMult, ReentryBars (R2 A09 best)

PREFIX = "ETHBOD_R3_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_eth_bollingerbreakout_daily3_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    payload = {
        "round": 3, "strategy": SIGNAL, "symbol": SYMBOL, "timeframe": "Daily",
    ...
    out = OUTPUT_DIR / "final_params_eth_bollingerbreakout_daily3.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto on ETHUSDT HOT Daily -- Round 3 BBmult confirm (IS 2022/01-2026/01; seed R2 10/1.4/3.0/14)")
    ...
    # R3 BBmult confirm around R2 A09 best: BBLen=10 BBmult=1.4 ATRMult=3.0 ReentryBars=14 (DAILY units)
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (9,11,1),   (1.35,1.45,0.05),(2.75,3.25,0.25),(13,15,1)))  # Rule 5 baseline
    _do(2, "02_bbmult_fine",  _cfg("02_bbmult_fine",  (9,11,1),   (1.0,1.8,0.025), (2.75,3.25,0.25),(13,15,1)))  # NAIL BBmult 1.0-1.8
    _do(3, "03_bbmult_x_len", _cfg("03_bbmult_x_len", (4,16,1),   (1.0,1.8,0.05),  (3.0,3.0,0.25),  (14,14,1)))   # BBmult x BBLen (BBLen/Re -> _safe)
    _do(4, "04_atrmult_fine", _cfg("04_atrmult_fine", (8,12,1),   (1.3,1.5,0.05),  (2.0,5.0,0.25),  (13,15,1)))  # nail ATRMult 2-5
    _do(5, "05_bbmult_vlow",  _cfg("05_bbmult_vlow",  (8,12,1),   (0.6,1.2,0.05),  (2.75,3.25,0.25),(13,15,1)))  # check BBmult below 1.4
    _do(6, "06_reentry_fine", _cfg("06_reentry_fine", (8,12,2),   (1.35,1.45,0.05),(2.75,3.25,0.25),(0,30,1)))   # nail ReentryBars 0-30
    _do(7, "07_bblen_fine",   _cfg("07_bblen_fine",   (2,20,1),   (1.3,1.5,0.1),   (2.75,3.25,0.25),(13,15,1)))  # nail BBLen 2-20
    _do(8, "08_combo_tight",  _cfg("08_combo_tight",  (8,12,1),   (1.25,1.55,0.05),(2.75,3.25,0.25),(13,15,1)))  # tight combo at peak
    _do(9, "09_bbmult_high",  _cfg("09_bbmult_high",  (8,12,1),   (1.5,2.6,0.1),   (2.75,3.0,0.25), (13,15,1)))  # confirm BBmult>1.4 worse
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto ETHUSDT Daily Round-3 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_BollingerBreakout_crypto ETHUSDT HOT Daily R3 BBmult confirm")
