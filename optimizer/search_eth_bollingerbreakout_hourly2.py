"""
search_eth_bollingerbreakout_hourly.py -- SFJ_BollingerBreakout_crypto on ETHUSDT HOT Hourly, Round 2 confirm (IS 2022/01-2026/01)
...
SEED_LEN, SEED_ATRL, SEED_MULT, SEED_RE = 3.0, 1.4, 15.45, 6.0  # BBLen, BBmult, ATRMult, ReentryBars (R1 A11 best)

PREFIX = "ETHBO_R2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_eth_bollingerbreakout_hourly2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_eth_bollingerbreakout_hourly2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto on ETHUSDT HOT Hourly -- Round 2 confirm (IS 2022/01-2026/01; seed R1 3/1.4/15.45/6)")
    ...
    # R2 confirmation around R1 A11 best: BBLen=3 BBmult=1.4 ATRMult=15.45 ReentryBars=6
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (2,4,1),    (1.3,1.5,0.1), (15,16,0.5), (5,7,1)))     # Rule 5 baseline
    _do(2, "02_bblen_fine",   _cfg("02_bblen_fine",   (2,12,1),   (1.3,1.5,0.1), (15,16,0.5), (4,8,2)))     # nail BBLen 2-12
    _do(3, "03_bbmult_fine",  _cfg("03_bbmult_fine",  (2,5,1),    (0.8,2.0,0.05),(15,16,0.5), (5,7,1)))     # nail BBmult 0.8-2.0
    _do(4, "04_atrmult_fine", _cfg("04_atrmult_fine", (2,5,1),    (1.3,1.5,0.1), (12,18,0.5), (5,7,1)))     # nail ATRMult 12-18
    _do(5, "05_atrmult_high", _cfg("05_atrmult_high", (2,6,2),    (1.3,1.5,0.1), (15,20,0.5), (4,8,2)))     # push ATRMult toward 20
    _do(6, "06_reentry_fine", _cfg("06_reentry_fine", (2,6,2),    (1.3,1.5,0.1), (15,16,0.5), (0,20,1)))    # nail ReentryBars 0-20
    _do(7, "07_bblen_micro",  _cfg("07_bblen_micro",  (2,8,1),    (1.2,1.6,0.1), (14.5,16.5,0.5),(4,8,1)))  # micro BBLen at peak
    _do(8, "08_combo_tight",  _cfg("08_combo_tight",  (2,5,1),    (1.3,1.55,0.05),(15,16,0.25),(5,7,1)))    # tight combo at peak
    _do(9, "09_bbmult_low",   _cfg("09_bbmult_low",   (2,5,1),    (0.8,1.5,0.1), (15,16,0.5), (5,7,1)))     # check BBmult below 1.4
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto ETHUSDT Hourly Round-2 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_BollingerBreakout_crypto ETHUSDT HOT Hourly R2 confirm")
