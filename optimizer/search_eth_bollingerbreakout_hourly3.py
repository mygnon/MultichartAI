"""
search_eth_bollingerbreakout_hourly.py -- SFJ_BollingerBreakout_crypto on ETHUSDT HOT Hourly, Round 3 BBmult-floor confirm (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\eth_bollingerbreakout_hourly_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT, SEED_RE = 4.0, 0.8, 15.5, 6.0  # BBLen, BBmult, ATRMult, ReentryBars (R2 A03 best)

PREFIX = "ETHBO_R3_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_eth_bollingerbreakout_hourly3_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_eth_bollingerbreakout_hourly3.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto on ETHUSDT HOT Hourly -- Round 3 BBmult-floor confirm (IS 2022/01-2026/01; seed R2 4/0.8/15.5/6)")
    ...
    # R3 BBmult-floor confirm around R2 A03 best: BBLen=4 BBmult=0.8 ATRMult=15.5 ReentryBars=6
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (3,5,1),    (0.75,0.85,0.05),(15,16,0.5), (5,7,1)))    # Rule 5 baseline
    _do(2, "02_bbmult_floor", _cfg("02_bbmult_floor", (4,4,1),    (0.5,1.0,0.025), (15,16,0.5), (5,7,1)))    # NAIL BBmult 0.5-1.0 (BBLen fixed -> _safe)
    _do(3, "03_bbmult_x_len", _cfg("03_bbmult_x_len", (2,8,1),    (0.5,1.0,0.05),  (15,16,0.5), (6,6,1)))     # BBmult 0.5-1.0 x BBLen
    _do(4, "04_bbmult_x_atr", _cfg("04_bbmult_x_atr", (3,5,1),    (0.5,1.0,0.05),  (14,17,0.5), (5,7,1)))     # BBmult x ATRMult
    _do(5, "05_atrmult_fine", _cfg("05_atrmult_fine", (3,5,1),    (0.7,0.9,0.05),  (13,18,0.5), (5,7,1)))     # ATRMult fine at low BBmult
    _do(6, "06_reentry_fine", _cfg("06_reentry_fine", (3,5,1),    (0.7,0.9,0.1),   (15,16,0.5), (0,20,1)))    # ReentryBars 0-20
    _do(7, "07_bblen_fine",   _cfg("07_bblen_fine",   (2,12,1),   (0.7,0.9,0.1),   (15,16,0.5), (5,7,1)))     # BBLen 2-12 at low BBmult
    _do(8, "08_combo_tight",  _cfg("08_combo_tight",  (3,6,1),    (0.6,0.95,0.05), (15,16,0.25),(5,7,1)))     # tight combo at peak
    _do(9, "09_bbmult_vlow",  _cfg("09_bbmult_vlow",  (3,5,1),    (0.5,0.7,0.025), (15,16,0.5), (5,7,1)))     # very-low BBmult 0.5-0.7
    ...
    log.info("==============================================================")
    log.info("  SFJ_BollingerBreakout_crypto ETHUSDT Hourly Round-3 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_BollingerBreakout_crypto ETHUSDT HOT Hourly R3 BBmult-floor confirm")
