"""
search_eth_closechannelbreakout_daily.py -- SFJ_CloseChannelBreakout_crypto on ETHUSDT HOT Daily, Round 1 (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\eth_closechannelbreakout_daily_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT = 20.0, 7.0, 13.0  # Length, ATRMult, ReentryBars

PREFIX = "ETHCCBD_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_eth_closechannelbreakout_daily_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    payload = {
        "round": 1, "strategy": SIGNAL, "symbol": SYMBOL, "timeframe": "Daily (1440 min)",
    ...
    out = OUTPUT_DIR / "final_params_eth_closechannelbreakout_daily.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    # static attempts (3D)
    _do(1, "01_global_wide",  _cfg("01_global_wide",  (5,100,5),   (2.0,12.0,1.0), (0,30,5)))    # Length x ATRMult x ReentryBars
    _do(2, "02_classic",      _cfg("02_classic",      (5,40,2),    (5.0,9.0,0.5),  (8,20,2)))
    _do(3, "03_length_fine",  _cfg("03_length_fine",  (2,60,2),    (6.0,8.0,0.5),  (10,16,2)))
    _do(4, "04_atrmult_fine", _cfg("04_atrmult_fine", (8,28,2),    (3.0,12.0,0.5), (10,16,2)))
    _do(5, "05_reentry_fine", _cfg("05_reentry_fine", (8,28,2),    (6.0,8.0,0.5),  (0,30,1)))
    _do(6, "06_wide_trail",   _cfg("06_wide_trail",   (5,50,5),    (8.0,20.0,0.5), (5,20,5)))
    _do(7, "07_short_len",    _cfg("07_short_len",    (2,20,1),    (4.0,10.0,0.5), (5,20,5)))
    _do(8, "08_long_len",     _cfg("08_long_len",     (40,300,10), (3.0,9.0,0.5),  (0,20,5)))
    _do(9, "09_global_bound", _cfg("09_global_bound", (5,300,15),  (1.0,18.0,1.0), (0,40,10)))
    ...
    log.info("==============================================================")
    log.info("  SFJ_CloseChannelBreakout_crypto ETHUSDT Daily Round-1 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
