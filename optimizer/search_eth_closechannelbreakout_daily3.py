"""
search_eth_closechannelbreakout_daily3.py -- SFJ_CloseChannelBreakout_crypto on ETHUSDT HOT Daily, Round 1 (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\eth_closechannelbreakout_daily3_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT = 3.0, 3.0, 5.0  # R3 seed = R2 Obj-max (short-Length narrow-trail)

PREFIX = "ETHCCBD3_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_eth_closechannelbreakout_daily3_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    payload = {
        "round": 3, "strategy": SIGNAL, "symbol": SYMBOL, "timeframe": "Daily (1440 min)",
    ...
    out = OUTPUT_DIR / "final_params_eth_closechannelbreakout_daily3.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    # static attempts (3D)
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (2,4,1),    (2.5,3.5,0.5),  (4,6,1)))     # Rule-5 + tight box (incl 3/3/5)
    _do(2, "02_length_fine",  _cfg("02_length_fine",  (1,10,1),   (2.5,3.5,0.5),  (4,6,1)))     # MAIN: Length 1-10
    _do(3, "03_atrmult_fine", _cfg("03_atrmult_fine", (2,4,1),    (1.5,4.0,0.25), (4,6,1)))
    _do(4, "04_reentry_fine", _cfg("04_reentry_fine", (2,4,1),    (2.5,3.5,0.5),  (0,15,1)))
    _do(5, "05_length_x_atr", _cfg("05_length_x_atr", (1,10,1),   (2.0,4.0,0.5),  (4,6,1)))
    _do(6, "06_high_freq",    _cfg("06_high_freq",    (1,5,1),    (1.0,3.0,0.25), (2,8,1)))
    _do(7, "07_combo_2d",     _cfg("07_combo_2d",     (1,8,1),    (2.0,4.0,0.25), (3,9,1)))
    _do(8, "08_midlen_recheck",_cfg("08_midlen_recheck",(18,30,2),(2.5,3.5,0.5),  (10,14,1)))   # confirm short beats R1 24/3/12
    _do(9, "09_atrmult_low",  _cfg("09_atrmult_low",  (2,4,1),    (0.5,2.5,0.25), (4,6,1)))     # verify <2.5 worse
    ...
    log.info("==============================================================")
    log.info("  SFJ_CloseChannelBreakout_crypto ETHUSDT Daily Round-3 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
