"""
search_eth_closechannelbreakout_hourly2.py -- SFJ_CloseChannelBreakout_crypto on ETHUSDT HOT Hourly, Round 1 (IS 2022/01-2026/01)
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\eth_closechannelbreakout_hourly2_search")
...
SEED_LEN, SEED_ATRL, SEED_MULT = 7.0, 15.0, 7.0  # R2 seed = R1 wide-trail champion

PREFIX = "ETHCCB2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_eth_closechannelbreakout_hourly2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(obj_best, np_best, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_eth_closechannelbreakout_hourly2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  SFJ_VolatilityBreakout_crypto on ETHUSDT HOT Hourly -- Round 1 (IS 2022/01-2026/01)")
    ...
    # static attempts (3D)
    _do(1, "01_retest_seed",  _cfg("01_retest_seed",  (5,9,1),    (14.0,16.0,0.5),(5,9,1)))     # Rule-5 + tight box (incl 7/15/7)
    _do(2, "02_length_fine",  _cfg("02_length_fine",  (2,20,1),   (14.5,15.5,0.5),(6,8,1)))
    _do(3, "03_atrmult_fine", _cfg("03_atrmult_fine", (5,9,1),    (10.0,20.0,0.5),(6,8,1)))
    _do(4, "04_reentry_fine", _cfg("04_reentry_fine", (5,9,1),    (14.5,15.5,0.5),(0,30,1)))
    _do(5, "05_narrow_check", _cfg("05_narrow_check", (5,12,1),   (6.0,10.0,0.5), (10,20,2)))   # does BNB/BTC narrow-trail beat?
    _do(6, "06_atrmult_low",  _cfg("06_atrmult_low",  (5,9,1),    (0.5,14.0,0.5), (5,9,1)))      # verify <14 worse
    _do(7, "07_short_len",    _cfg("07_short_len",    (2,12,1),   (12.0,18.0,0.5),(4,12,2)))
    _do(8, "08_combo_2d",     _cfg("08_combo_2d",     (4,12,1),   (13.0,17.0,0.5),(4,12,1)))
    _do(9, "09_atrmult_high", _cfg("09_atrmult_high", (5,9,1),    (15.0,20.0,0.5),(5,9,1)))      # verify >16 worse
    ...
    log.info("==============================================================")
    log.info("  SFJ_CloseChannelBreakout_crypto ETHUSDT Hourly Round-2 COMPLETE (%.1f min)", (time.time()-_RUN_T0)/60)
    if obj_best:
...
def main():
    ap = argparse.ArgumentParser(description="SFJ_VolatilityBreakout_crypto ETHUSDT HOT Hourly R1 search")
