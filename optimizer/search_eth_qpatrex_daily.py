"""
search_eth_qpatrex_daily.py  QuantPassATRex on ETHUSDT HOT Daily, Round 1
...
Reference ceilings:
  BTC Hourly R3: $3,293 (Len=125)
  BTC Daily R3:  $3,511 (Len=24, Su=0.75, Ni=3.5) -- 8-attempt convergence
  ETH Hourly R3: $5,198 (Len=24, Su=1.48, Ni=2.47) -- ETH dominated BTC by 58%
  BNB Hourly R5: $39,921 (Len=235, Su=0.58575, Ni=2.1275)

ETH Daily is new territory. ETH price ~$3K -> ~333 contracts/trade.
Hypothesis: ETH Daily may exceed ETH Hourly $5,198 (similar to BTC where Daily slightly higher).
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\eth_qpatrex_daily_search")
...
# Strategy defaults as nominal seed (no prior ETH daily results)
SEED_LEN = 55.0
SEED_SU  = 0.75
SEED_NI  = 1.5
SEED_NP  = 0.0
...
_LOG_FILE = OUTPUT_DIR / f"search_eth_qpatrex_daily_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    payload = {
        ...
        "notes": {
            ...
            "note":     "Daily timeframe (1440 min). ETH ~$3K -> ~333 contracts/trade. ETH Hourly ceiling $5,198.",
        },
        "best_params":  best_entry,
        "all_attempts": attempt_log,
    }
    out = OUTPUT_DIR / "final_params_eth_qpatrex_daily.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  QuantPassATRex on ETHUSDT HOT Daily -- Round 1")
    ...
    log.info("  ETH Hourly ceiling reference: $5,198 (Len=24 Su=1.48 Ni=2.47)")
    log.info("  BTC Daily ceiling reference: $3,511 (Len=24 Su=0.75 Ni=3.5)")
    log.info("==============================================================")
    ...
    log.info("==============================================================")
    log.info("  QuantPassATRex ETHUSDT Daily Round-1 COMPLETE")
...
def main():
    parser = argparse.ArgumentParser(
        description="QuantPassATRex ETHUSDT HOT Daily R1 parameter search")
