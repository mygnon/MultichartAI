"""
search_eth_supertrend_daily.py — SFJ_SuperTrend_crypto on ETHUSDT HOT Daily, Round 1
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\eth_supertrend_daily_search")
...
_LOG_FILE = OUTPUT_DIR / f"search_eth_supertrend_daily_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_eth_supertrend_daily.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  ETH Daily SFJ_SuperTrend_crypto NP>100K -- Round 1")
    ...
    log.info("==============================================================")
    log.info("  ETH Daily SuperTrend_crypto Round-1 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="ETH Daily SFJ_SuperTrend_crypto NP>100K Round-1 search")
