"""
search_eth_supertrend_hourly.py — SFJ_SuperTrend_crypto on ETHUSDT HOT Hourly, Round 1
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\eth_supertrend_hourly_search")
...
SEED_AT, SEED_ML = 10.0, 3.0   # signal defaults
SEED_NP = 0.0

PREFIX = "ETHSTH1_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_eth_supertrend_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_eth_supertrend_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  ETH Hourly SFJ_SuperTrend_crypto NP>100K -- Round 1")
    log.info("  IS window %s ~ %s  (chart-trimmed)", IS_RANGE[0], IS_RANGE[1])
    log.info("  Signal: %s  Symbol: %s  (2 params: ATRLength, Multiplier)", SIGNAL, SYMBOL)
    log.info("==============================================================")

    if not from_csv and conn is not None:
        mc.ensure_chart_ready(conn, _cfg("seed", (8, 12, 1), (2.5, 3.5, 0.25)))
    ...
    attempts_config = [
        ("01_global_coarse", (2, 400, 8),    (0.5, 10.0, 0.25)),
        ("02_short_ATR",     (1, 60, 1),     (0.5, 8.0, 0.25)),
        ("03_mid_ATR",       (40, 200, 4),   (1.0, 6.0, 0.125)),
        ("04_long_ATR",      (150, 600, 10), (1.0, 6.0, 0.25)),
        ("05_low_mult",      (2, 200, 4),    (0.3, 3.0, 0.1)),
        ("06_high_mult",     (2, 200, 4),    (4.0, 12.0, 0.25)),
        ("07_vlong_ATR",     (400, 1500, 25),(1.0, 6.0, 0.25)),
        ("08_fine_default",  (2, 50, 1),     (1.5, 5.0, 0.125)),
    ]
    ...
    log.info("==============================================================")
    log.info("  ETH Hourly SuperTrend_crypto Round-1 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="ETH Hourly SFJ_SuperTrend_crypto NP>100K Round-1 search")
