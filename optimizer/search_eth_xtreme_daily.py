"""
search_eth_xtreme_daily.py — SFJ_XtremeStop_Crypto on ETHUSDT HOT Daily, Round 1
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\eth_xtreme_daily_search")
...
SEED_X, SEED_LY, SEED_SY = 20.0, 3.25, 3.25
SEED_NP = 0.0

PREFIX = "ETHXTD1_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_eth_xtreme_daily_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_eth_xtreme_daily.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  ETH Daily SFJ_XtremeStop_Crypto NP>100K -- Round 1 (FIRST crypto Daily)")
    ...
    if not from_csv and conn is not None:
        mc.ensure_chart_ready(conn, _cfg("seed", (10, 30, 5), (3.0, 3.5, 0.25), (3.0, 3.5, 0.25)))
    ...
    attempts_config = [
        ("01_global_coarse", (1, 60, 3),      (0.5, 7.5, 0.5),  (0.5, 7.5, 0.5)),
        ("02_short_X",       (1, 30, 1),      (0.5, 6.0, 0.5),  (0.5, 6.0, 0.5)),
        ("03_mid_X",         (20, 120, 5),    (1.0, 8.0, 0.5),  (1.0, 8.0, 0.5)),
        ("04_long_X",        (100, 400, 20),  (1.0, 7.0, 0.5),  (1.0, 7.0, 0.5)),
        ("05_high_pct",      (5, 55, 5),      (5.0, 15.0, 0.5), (5.0, 15.0, 0.5)),
        ("06_low_pct",       (1, 49, 3),      (0.2, 3.0, 0.2),  (0.2, 3.0, 0.2)),
        ("07_asym_LY_high",  (1, 61, 4),      (2.0, 12.0, 0.5), (0.5, 5.0, 0.5)),
        ("08_asym_SY_high",  (1, 61, 4),      (0.5, 5.0, 0.5),  (2.0, 12.0, 0.5)),
    ]
    ...
    log.info("==============================================================")
    log.info("  ETH Daily XtremeStop_Crypto Round-1 COMPLETE")
