"""
search_eth_xtreme_hourly2.py — SFJ_XtremeStop_Crypto on ETHUSDT HOT Hourly, Round 2
...
OUTPUT_DIR = Path(r"C:\Users\Tim\MultichartAI\results\eth_xtreme_hourly2_search")
...
SEED_X, SEED_LY, SEED_SY = 796.0, 5.85, 3.1
SEED_NP = 0.0

PREFIX = "ETHXTH2_"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_eth_xtreme_hourly2_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_eth_xtreme_hourly2.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("==============================================================")
    log.info("  ETH Hourly SFJ_XtremeStop_Crypto NP>100K -- Round 2")
    log.info("  IS window %s ~ %s  (chart-trimmed)", IS_RANGE[0], IS_RANGE[1])
    log.info("  R1 champ X=796 LY=5.85 SY=3.1 NP=3574 (long-X asym 48tr; confirming peak)", )
    log.info("==============================================================")

    if not from_csv and conn is not None:
        mc.ensure_chart_ready(conn, _cfg("seed", (786, 806, 5), (5.3, 6.4, 0.25), (2.6, 3.6, 0.25)))
    ...
    attempts_config = [
        ("01_X_push",        (600, 1500, 50), (4.0, 8.0, 0.5),  (2.0, 5.0, 0.5)),
        ("02_X_vlong",       (1000, 3000, 100),(4.0, 8.0, 0.5), (2.0, 5.0, 0.5)),
        ("03_LYSY_refine",   (750, 850, 10),  (3.0, 9.0, 0.25), (1.5, 5.0, 0.25)),
        ("04_fine_zoom",     (786, 806, 2),   (5.3, 6.4, 0.1),  (2.6, 3.6, 0.1)),
        ("05_SY_low",        (780, 810, 5),   (5.0, 7.0, 0.25), (0.5, 3.5, 0.25)),
        ("06_X_mid_recheck", (300, 700, 25),  (4.0, 8.0, 0.5),  (2.0, 5.0, 0.5)),
        ("07_asym_retry",    (700, 900, 20),  (2.0, 12.0, 0.5), (0.5, 5.0, 0.5)),
        ("08_short_X_check", (1, 30, 2),      (2.0, 8.0, 0.5),  (2.0, 8.0, 0.5)),
    ]
    ...
    log.info("==============================================================")
    log.info("  ETH Hourly XtremeStop_Crypto Round-2 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="ETH Hourly SFJ_XtremeStop_Crypto NP>100K Round-2 search")
