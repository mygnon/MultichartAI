"""
search_nq_ct_hourly.py — SFJ_15Dworkshop_lesson5_countertrend_LS on CME.NQ HOT Hourly, Round 1
...
Search philosophy:
  - Shorter period + lower stddev → high-frequency mean-reversion
  - Medium period + medium stddev → moderate counter-trend
  - Longer period + higher stddev → rare extreme-move fades
  - Allow asymmetry: LL≠LS and SL≠SS

Attempt schedule (12 attempts, ≤5,000 combos each):
  A01 broad_sweep      : LL(10-80 s5)×SL(1.5-4.5 s1)×LS(10-80 s5)×SS(1.5-4.5 s1)   = 3600
  A02 fine_stddev      : LL(20-70 s10)×SL(1.0-5.5 s0.5)×LS(20-70 s10)×SS(1.0-5.5 s0.5) = 3600
  A03 medium_fine      : LL(20-70 s5)×SL(2.0-4.5 s0.5)×LS(20-70 s5)×SS(2.0-4.5 s0.5)= 4356
  A04 long_period      : LL(60-160 s10)×SL(2.0-4.5 s0.5)×LS(60-160 s10)×SS(2.0-4.5 s0.5)= 4356
  A05 short_period     : LL(2-30 s2)×SL(1.0-4.0 s1)×LS(2-30 s2)×SS(1.0-4.0 s1)     = 3600
  A06 asymmetric       : LL(20-80 s5)×SL(2.0-5.0 s1)×LS(5-50 s5)×SS(2.0-5.0 s1)    = 2080
  A07 high_stddev      : LL(20-80 s10)×SL(3.5-6.5 s0.5)×LS(20-80 s10)×SS(3.5-6.5 s0.5)= 2401
  A08 low_stddev       : LL(20-80 s10)×SL(1.0-2.8 s0.2)×LS(20-80 s10)×SS(1.0-2.8 s0.2)= 4900
  A09 default_region   : LL(38-56 s2)×SL(3.0-4.5 s0.3)×LS(38-56 s2)×SS(3.0-4.5 s0.3) = 3600
  A10 adaptive_zoom    : (dynamic from R1 best NP)
  A11 very_long_period : LL(80-200 s20)×SL(3.0-5.5 s0.5)×LS(80-200 s20)×SS(3.0-5.5 s0.5)= 1764
  A12 global_boundary  : LL(5-150 s15)×SL(1.0-6.0 s1)×LS(5-150 s15)×SS(1.0-6.0 s1) = 4356
"""
...
# Default params from docx as initial seeds
SEED_LL, SEED_SL = 46.0, 3.8
SEED_LS, SEED_SS = 46.0, 3.8
SEED_NP          = -1_000_000.0

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
_LOG_FILE = OUTPUT_DIR / f"search_nq_ct_hourly_{int(time.time())}.log"
logging.basicConfig(
    level=logging.INFO,
...
def csv_for(name: str) -> Path:
    return OUTPUT_DIR / f"NQCT1_{name}_raw.csv"
...
def run_or_load(name, cfg, conn, from_csv):
    ...
    if from_csv or csv_path.exists():
        ...
        return None
    log.info("=== Starting NQCT1_%s (%d combos) ===", name, cfg.total_runs())
    t0 = time.time()
    try:
...
def save_json(best_entry, attempt_log, target_met):
    ...
    out = OUTPUT_DIR / "final_params_nq_ct_hourly.json"
...
def run_search(conn, from_csv, start_attempt):
    ...
    log.info("══════════════════════════════════════════════════════════════")
    log.info("  NQ Hourly countertrend_LS NP>700K — Round 1")
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A01  broad_sweep — wide LL/LS, coarse SL/SS
    #      LL(10-80 s5)×SL(1.5-4.5 s1)×LS(10-80 s5)×SS(1.5-4.5 s1)  = 15×4×15×4 = 3600
    # ──────────────────────────────────────────────────────────────────────
    A = 1
    _n = "01_broad_sweep"
    _c = _cfg(_n, (10, 80, 5), (1.5, 4.5, 1.0), (10, 80, 5), (1.5, 4.5, 1.0))
    log.info("A01  LL(10-80 s5)×SL(1.5-4.5 s1)×LS(10-80 s5)×SS(1.5-4.5 s1)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A02  fine_stddev — fixed medium LENGTH, fine STDDEV scan
    #      LL(20-70 s10)×SL(1.0-5.5 s0.5)×LS(20-70 s10)×SS(1.0-5.5 s0.5)  = 6×10×6×10 = 3600
    # ──────────────────────────────────────────────────────────────────────
    A = 2
    _n = "02_fine_stddev"
    _c = _cfg(_n, (20, 70, 10), (1.0, 5.5, 0.5), (20, 70, 10), (1.0, 5.5, 0.5))
    log.info("A02  LL(20-70 s10)×SL(1.0-5.5 s0.5)×LS(20-70 s10)×SS(1.0-5.5 s0.5)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
        _update(run_or_load(_n, _c, conn, from_csv), _c, _n, A, _c.total_runs())
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A03  medium_fine — finer LENGTH grid with moderate STDDEV
    #      LL(20-70 s5)×SL(2.0-4.5 s0.5)×LS(20-70 s5)×SS(2.0-4.5 s0.5)  = 11×6×11×6 = 4356
    # ──────────────────────────────────────────────────────────────────────
    A = 3
    _n = "03_medium_fine"
    _c = _cfg(_n, (20, 70, 5), (2.0, 4.5, 0.5), (20, 70, 5), (2.0, 4.5, 0.5))
    log.info("A03  LL(20-70 s5)×SL(2.0-4.5 s0.5)×LS(20-70 s5)×SS(2.0-4.5 s0.5)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
        _update(run_or_load(_n, _c, conn, from_csv), _c, _n, A, _c.total_runs())
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A04  long_period — longer BB periods (60-160)
    #      LL(60-160 s10)×SL(2.0-4.5 s0.5)×LS(60-160 s10)×SS(2.0-4.5 s0.5)  = 11×6×11×6 = 4356
    # ──────────────────────────────────────────────────────────────────────
    A = 4
    _n = "04_long_period"
    _c = _cfg(_n, (60, 160, 10), (2.0, 4.5, 0.5), (60, 160, 10), (2.0, 4.5, 0.5))
    log.info("A04  LL(60-160 s10)×SL(2.0-4.5 s0.5)×LS(60-160 s10)×SS(2.0-4.5 s0.5)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
        _update(run_or_load(_n, _c, conn, from_csv), _c, _n, A, _c.total_runs())
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A05  short_period — short BB periods (2-30) for mean-reversion
    #      LL(2-30 s2)×SL(1.0-4.0 s1)×LS(2-30 s2)×SS(1.0-4.0 s1)  = 15×4×15×4 = 3600
    # ──────────────────────────────────────────────────────────────────────
    A = 5
    _n = "05_short_period"
    _c = _cfg(_n, (2, 30, 2), (1.0, 4.0, 1.0), (2, 30, 2), (1.0, 4.0, 1.0))
    log.info("A05  LL(2-30 s2)×SL(1.0-4.0 s1)×LS(2-30 s2)×SS(1.0-4.0 s1)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
        _update(run_or_load(_n, _c, conn, from_csv), _c, _n, A, _c.total_runs())
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A06  asymmetric — different LL and LS (asymmetric long/short)
    #      LL(20-80 s5)×SL(2.0-5.0 s1)×LS(5-50 s5)×SS(2.0-5.0 s1)  = 13×4×10×4 = 2080
    # ──────────────────────────────────────────────────────────────────────
    A = 6
    _n = "06_asymmetric"
    _c = _cfg(_n, (20, 80, 5), (2.0, 5.0, 1.0), (5, 50, 5), (2.0, 5.0, 1.0))
    log.info("A06  LL(20-80 s5)×SL(2.0-5.0 s1)×LS(5-50 s5)×SS(2.0-5.0 s1)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
        _update(run_or_load(_n, _c, conn, from_csv), _c, _n, A, _c.total_runs())
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A07  high_stddev — wide bands (3.5-6.5σ), rare extreme entries
    #      LL(20-80 s10)×SL(3.5-6.5 s0.5)×LS(20-80 s10)×SS(3.5-6.5 s0.5)  = 7×7×7×7 = 2401
    # ──────────────────────────────────────────────────────────────────────
    A = 7
    _n = "07_high_stddev"
    _c = _cfg(_n, (20, 80, 10), (3.5, 6.5, 0.5), (20, 80, 10), (3.5, 6.5, 0.5))
    log.info("A07  LL(20-80 s10)×SL(3.5-6.5 s0.5)×LS(20-80 s10)×SS(3.5-6.5 s0.5)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
        _update(run_or_load(_n, _c, conn, from_csv), _c, _n, A, _c.total_runs())
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A08  low_stddev — tight bands (1.0-2.8σ), high-frequency entries
    #      LL(20-80 s10)×SL(1.0-2.8 s0.2)×LS(20-80 s10)×SS(1.0-2.8 s0.2)  = 7×10×7×10 = 4900
    # ──────────────────────────────────────────────────────────────────────
    A = 8
    _n = "08_low_stddev"
    _c = _cfg(_n, (20, 80, 10), (1.0, 2.8, 0.2), (20, 80, 10), (1.0, 2.8, 0.2))
    log.info("A08  LL(20-80 s10)×SL(1.0-2.8 s0.2)×LS(20-80 s10)×SS(1.0-2.8 s0.2)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
        _update(run_or_load(_n, _c, conn, from_csv), _c, _n, A, _c.total_runs())
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A09  default_region — fine grid around default (LL=LS=46, SL=SS=3.8)
    #      LL(38-56 s2)×SL(3.0-4.5 s0.3)×LS(38-56 s2)×SS(3.0-4.5 s0.3)  = 10×6×10×6 = 3600
    # ──────────────────────────────────────────────────────────────────────
    A = 9
    _n = "09_default_region"
    _c = _cfg(_n, (38, 56, 2), (3.0, 4.5, 0.3), (38, 56, 2), (3.0, 4.5, 0.3))
    log.info("A09  LL(38-56 s2)×SL(3.0-4.5 s0.3)×LS(38-56 s2)×SS(3.0-4.5 s0.3)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
        _update(run_or_load(_n, _c, conn, from_csv), _c, _n, A, _c.total_runs())
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A11  very_long_period — LL/LS=80-200, rare extreme moves
    #      LL(80-200 s20)×SL(3.0-5.5 s0.5)×LS(80-200 s20)×SS(3.0-5.5 s0.5)  = 7×6×7×6 = 1764
    # ──────────────────────────────────────────────────────────────────────
    A = 11
    _n = "11_very_long_period"
    _c = _cfg(_n, (80, 200, 20), (3.0, 5.5, 0.5), (80, 200, 20), (3.0, 5.5, 0.5))
    log.info("A11  LL(80-200 s20)×SL(3.0-5.5 s0.5)×LS(80-200 s20)×SS(3.0-5.5 s0.5)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
        _update(run_or_load(_n, _c, conn, from_csv), _c, _n, A, _c.total_runs())
    ...
    # ──────────────────────────────────────────────────────────────────────
    # A12  global_boundary — full boundary sweep
    #      LL(5-155 s15)×SL(1.0-6.0 s1)×LS(5-155 s15)×SS(1.0-6.0 s1)  = 11×6×11×6 = 4356
    # ──────────────────────────────────────────────────────────────────────
    A = 12
    _n = "12_global_boundary"
    _c = _cfg(_n, (5, 155, 15), (1.0, 6.0, 1.0), (5, 155, 15), (1.0, 6.0, 1.0))
    log.info("A12  LL(5-155 s15)×SL(1.0-6.0 s1)×LS(5-155 s15)×SS(1.0-6.0 s1)  %d combos",
             _c.total_runs())
    if start_attempt <= A:
        _update(run_or_load(_n, _c, conn, from_csv), _c, _n, A, _c.total_runs())
    ...
    # ──────────────────────────────────────────────────────────────────────
    log.info("══════════════════════════════════════════════════════════════")
    log.info("  NQ Hourly countertrend_LS Round-1 COMPLETE")
...
def main():
    ap = argparse.ArgumentParser(
        description="NQ Hourly countertrend_LS NP>700K Round-1 search")
